...
CRE_SIGNALS = [
    ...
    dict(category="Institutional", title="UT System Regents Approve $1B Phase I of UT Dell Medical Center",
         subtitle="A $5 Billion Campus Plan Clears Its First Real Governance Hurdle",
         date="August 12, 2026",
         trigger=f'''{src("https://communityimpact.com/austin/northwest-austin/development/ut-board-of-regents-approves-first-phase-of-the-ut-dell-medical-center/", "The UT System Board of Regents added Phase I of the new UT Dell Medical Center to the university's capital improvement program")}, clearing the way for design and site work on a 27-acre hospital and outpatient complex (300&ndash;500 beds) off MoPac in Northwest Austin; Phase I is budgeted at up to $1 billion within a larger $5 billion, 300-acre &ldquo;UT Dell Campus for Advanced Research,&rdquo; with construction starting fall 2026 and completion targeted for December 2030.''',
         why="A regents vote adding a project to the capital improvement program is the specific governance step that turns a announced concept into a fundable, schedulable project &mdash; it's the university system formally committing its own balance sheet to a $5 billion campus plan, not just describing an ambition. Institutional medical-campus development at this scale is a multi-decade anchor for the surrounding submarket in a way few single corporate leases can match, and it's happening on the university's own capital improvement books rather than through a third-party developer.",
         implications=[
             "Converts a previously announced $5 billion campus concept into a formally budgeted, schedulable project",
             "Anchors a 300-acre Northwest Austin medical/research campus with a multi-decade development horizon",
             "Signals continued institutional capital commitment to Austin healthcare and life-sciences real estate specifically",
             "Sets a fall 2026 construction start and December 2030 completion target for the first, roughly $1 billion phase",
         ],
         watch="Whether design and site work proceed on the fall 2026 timeline, and disclosure of Phase II scope and budget for the broader 300-acre campus."),
    dict(category="Multifamily", title="Austin Clears Zoning Path for Two 180-Foot Riverside Towers",
         subtitle="A Corridor Plan Change Triples Allowable Height for 731 Combined Units",
         date="August 10, 2026",
         trigger=f'''{src("https://communityimpact.com/austin/east-austin/development/austin-advances-plans-for-180-foot-riverside-residential-towers/", "Two separate residential towers")} &mdash; 350 units at 1712 E. Riverside Drive/S. Lakeshore Boulevard, and 381 units at 1404 E. Riverside Drive on Lady Bird Lake &mdash; are advancing after being removed from the East Riverside Corridor regulating plan by a July 23 City Council vote, tripling their allowable height to 180 feet; both include affordable-housing set-asides or fee-in-lieu payments and public open-space commitments.''',
         why="Tripling allowable height via removal from a corridor regulating plan, rather than a standard rezoning case, shows how developers negotiate density bonuses through community-benefit agreements &mdash; affordable set-asides and public open space in exchange for far more buildable square footage. Two separate towers advancing on the same corridor-plan mechanism in the same vote is a stronger signal of a genuine policy shift than a single project's entitlement win would be.",
         implications=[
             "Triples allowable height on two separate Riverside-corridor sites via a single regulating-plan change",
             "Adds 731 combined units to the East Riverside pipeline once both towers are entitled and financed",
             "Provides a template (affordable set-asides, public open space) other Riverside corridor developers may replicate",
             "Signals the city remains willing to trade density bonuses for public-benefit commitments on this specific corridor",
         ],
         watch="Whether both towers secure construction financing and move to permitting, and if other East Riverside sites pursue similar regulating-plan removals."),
    dict(category="Multifamily", title="JPI to Build 425-Unit, $82M Apartment Complex at CedarView",
         subtitle="Suburban Cedar Park Development Keeps Moving Despite Broader Metro Caution",
         date="August 13, 2026",
         trigger=f'''{src("https://communityimpact.com/austin/cedar-park/development/425-unit-apartment-complex-coming-to-cedarview-development/", "Dallas-based JPI Development Group will build a 425-unit, 650,000-square-foot, $82 million multifamily project")} at 750 E. New Hope Drive in Cedar Park, anchored near Nebraska Furniture Mart, Scheels, a Marriott, and convention facilities; construction is slated to start January 2027 with completion targeted for January 2029.''',
         why="A well-capitalized, out-of-state developer committing $82 million to suburban Cedar Park, in an amenity-anchored location next to big-box retail and hospitality draws, is a specific bet on that submarket's staying power even as broader Austin-metro multifamily starts have slowed elsewhere this cycle &mdash; a useful counterpoint to weaker suburban starts data points this desk has tracked recently.",
         implications=[
             "Confirms continued institutional developer confidence in the 183A/Cedar Park suburban corridor specifically",
             "Adds 425 units anchored near existing big-box retail and hospitality demand drivers",
             "Provides a fresh construction-cost and unit-count benchmark for comparable suburban Austin-metro projects",
             "Sets a January 2027 start and January 2029 delivery to track against the broader suburban supply pipeline",
         ],
         watch="Whether construction begins on the January 2027 timeline, and lease-up pace once the project delivers in 2029."),
    dict(category="Multifamily", title="Knightvest Capital Acquires Three-Property, 1,027-Unit Austin Portfolio",
         subtitle="A Value-Add Buyer Says It Bought at a Significant Discount to Comparable Deals",
         date="August 18, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/austin-san-antonio/multifamily/knightvest-capital-acquires-3-multifamily-communities-in-austin", "Knightvest Capital acquired three Austin-area apartment communities totaling 1,027 units")} &mdash; Enclave at La Frontera (411 units, renamed Brixton), Lakeside at La Frontera (366 units, renamed Calder), and Legends Lake Creek (250 units, renamed Sutton) &mdash; in the Silicon Hills corridor near Round Rock; price was undisclosed, but Knightvest CEO David Moore said the portfolio was bought &ldquo;at a significant discount compared to similar type deals,&rdquo; with renovations planned.''',
         why="A buyer explicitly stating on the record that it bought at a significant discount to comparable deals is a rare, direct admission of where multifamily basis actually sits right now, rather than an analyst's inference from a single closed price. Acquiring three properties as one portfolio, rather than three separate deals, also lets Knightvest apply renovation and management scale across a concentrated Round Rock-corridor footprint from day one.",
         implications=[
             "Provides a rare, on-the-record admission that Austin-suburb multifamily is trading at a meaningful discount to recent comparables",
             "Concentrates 1,027 renamed, renovation-targeted units under one operator in the Silicon Hills/Round Rock corridor",
             "Signals continued value-add buyer appetite for discounted Austin-metro multifamily despite the broader slowdown",
             "Adds a three-property portfolio acquisition as a comp for other Round Rock-corridor multifamily owners considering a sale",
         ],
         watch="The undisclosed purchase price once it surfaces in public records, and Knightvest's renovation and repositioning timeline across all three renamed properties."),
]

CRE_FINAL_PARAGRAPHS = [
    "This week's biggest Austin story is institutional: the UT System Board of Regents formally added Phase I of the $5 billion UT Dell Medical Center campus to its capital improvement program, converting a previously announced concept into a funded, schedulable project. Read alongside Apollo's still-pending HQ2 real estate follow-through, Austin's highest-conviction commitments right now are coming from institutions and asset managers making multi-year bets, not opportunistic single-asset buyers.",
    "Multifamily dominates the rest of this week's signals, and it splits cleanly into entitlement, new construction, and acquisition. Austin's regulating-plan change unlocking two 180-foot Riverside towers and JPI's suburban CedarView project both represent fresh supply moving forward, while Knightvest's three-property, 1,027-unit Round Rock-corridor purchase &mdash; bought, in the buyer's own words, at a significant discount &mdash; is this week's clearest read on where multifamily basis actually sits.",
    "Cousins Properties' $208 million sale of One Eleven Congress remains this cycle's clearest downtown office repricing signal, still worth tracking as other owners weigh similar dispositions.",
]
CRE_FINAL_BULLETS = [
    "UT System regents formally funded Phase I of a $5 billion medical campus, Austin's biggest institutional commitment this week",
    "A regulating-plan change tripled allowable height for two Riverside towers, unlocking 731 combined multifamily units",
    "A value-add buyer said on the record it bought a 1,027-unit Austin portfolio at a significant discount to recent comparables",
    "A well-capitalized out-of-state developer is still committing to suburban Cedar Park multifamily despite the broader slowdown",
]
...
CRE_AUSTIN_BLOCK = market_block_html(
    "cre", "austin", True, "CRE", "Signal", "AUSTIN, TEXAS", "AUGUST 18, 2026", "JULY 23&ndash;AUG 18, 2026",
...
USC_SIGNALS = [
    ...
    dict(category="Industrial", title="19-Building San Dimas Industrial Park Trades for $41M",
         subtitle="A Small-Bay Multi-Tenant Park Still Draws Institutional Capital at 90% Leased",
         date="August 12, 2026",
         trigger=f'''{src("https://www.connectcre.com/stories/institutional-investor-snares-san-dimas-light-industrial-park/", "SRS Real Estate Partners arranged the $41 million sale of a 179,345-square-foot, 19-building light-industrial park in San Dimas")} to an institutional investor; the San Gabriel Valley property sits on 10.54 acres and was 90% leased to more than 70 tenants at sale.''',
         why="A 19-building, multi-tenant small-bay park trading to an institutional buyer at 90% leased is a specific bet on granular, diversified industrial income &mdash; more than 70 separate tenant relationships spread the rollover risk across a single trade in a way a single large-tenant industrial building doesn't. That an institutional investor, not a private local buyer, is the one absorbing this granularity confirms multi-tenant small-bay product still clears at scale even as some big-box industrial faces oversupply concerns elsewhere in the basin.",
         implications=[
             "Confirms institutional buyers still want granular, multi-tenant small-bay industrial income, not just single-tenant big-box product",
             "Provides a $41 million/179,345-SF basis for comparable San Gabriel Valley light-industrial parks",
             "Spreads rollover and vacancy risk across more than 70 tenants in a single institutional-scale trade",
             "Signals continued investor confidence in San Gabriel Valley industrial specifically despite broader vacancy pressure",
         ],
         watch="Whether the buyer discloses renovation or repositioning plans, and if comparable multi-tenant industrial parks in the San Gabriel Valley trade at similar pricing."),
    ...
    dict(category="Hospitality", title="KHP Capital Partners Sells Kimpton La Peer West Hollywood to Japan's APA Group for $63M",
         subtitle="A Cross-Border Buyer Pays $600K/Room and Keeps the Brand Flag",
         date="August 10, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/los-angeles/hotel/khp-sells-west-hollywood-kimpton-63-million", "San Francisco-based KHP Capital Partners sold the 105-room Kimpton La Peer hotel in West Hollywood's Design District to APA Group")}, a family-run Japanese hotel corporation, for $63 million ($600,000 per room); Newmark arranged the deal on APA's behalf, and APA plans to double its U.S. room count to 10,000 by 2030 while keeping the Kimpton flag on the property.''',
         why="A Japanese hospitality group paying $600,000 per room for a boutique West Hollywood hotel, as part of a stated plan to double its entire U.S. room count by 2030, signals real cross-border capital conviction in LA hospitality specifically, not just an opportunistic one-off. Keeping the existing Kimpton flag rather than converting to a proprietary brand also suggests the buyer values the operating platform and demand generation that comes with the existing management agreement, not just the real estate.",
         implications=[
             "Confirms continued cross-border capital appetite for boutique LA hospitality assets at a healthy per-room basis",
             "Provides a $600,000-per-room benchmark for comparable West Hollywood Design District hotel trades",
             "Signals APA Group's US expansion strategy specifically targets acquiring existing branded, operating hotels over ground-up development",
             "Reinforces brokerage (Newmark) and brand management (Kimpton) as durable value drivers in LA hospitality investment sales",
         ],
         watch="Whether APA Group pursues additional Southern California hotel acquisitions toward its 10,000-room 2030 target."),
    dict(category="Mixed-Use", title="Bankruptcy Court Approves $517M Sale of Stalled Oceanwide Plaza Towers",
         ...
         watch="Whether KPC and Lendlease close within the six-month window; the developers are now separately asking the city for a transient-occupancy-tax incentive agreement to help fund construction of the project's planned 184-room hotel, with a $150,000 city-commissioned study underway to evaluate the request.",
...
USC_FINAL_PARAGRAPHS = [
    "This week's Los Angeles signals keep confirming that institutional and cross-border capital is still finding its way into the market, just selectively. The San Dimas industrial park trade and KHP Capital's sale of the Kimpton La Peer to Japan's APA Group are two very different property types, but both show real buyers underwriting real income &mdash; a 70-plus-tenant industrial park and a boutique branded hotel &mdash; at healthy per-unit pricing.",
    "The Oceanwide Plaza story keeps evolving beyond the sale itself: the new developers are now asking the city for a transient-occupancy-tax incentive to help fund the project's planned hotel, a reminder that even a closed $517 million distressed-asset sale often needs additional public-private deal structuring before construction actually restarts.",
    "Rexford's continued disposition guidance and the IRG/Sachem governance fight, both still in motion from prior weeks, remain the clearest examples of LA industrial capital restructuring under stress, a contrast to the confidence-driven trades elsewhere on this week's desk.",
]
USC_FINAL_BULLETS = [
    "A 19-building, 70-plus-tenant industrial park traded to an institutional buyer at 90% leased, confirming multi-tenant industrial demand",
    "A Japanese hotel group paid $600,000 per room for a boutique West Hollywood hotel as part of a broader US expansion plan",
    "Oceanwide Plaza's new owners are now seeking a public tax incentive to help fund the stalled project's planned hotel component",
    "A minority-investor lawsuit is still fighting over the timing of a nearly $3 billion industrial-portfolio reverse merger",
]


CRE_USC_BLOCK = market_block_html(
    "cre", "usc", False, "CRE", "Signal", "LOS ANGELES, CA", "AUGUST 18, 2026", "JULY 15&ndash;AUG 18, 2026",
...
NYC_SIGNALS = [
    ...
    dict(category="Office", title="Citadel Anchors Vornado/Rudin's $6.2B 350 Park Avenue Tower With a Record NYC Lease",
         subtitle="A Formalized JV and a 1.05M-SF Anchor Lease Turn a Construction Loan Into a Real Project",
         date="August 11, 2026",
         trigger=f'''{src("https://www.globenewswire.com/news-release/2026/08/11/3343188/0/en/vornado-realty-trust-to-enter-into-350-park-avenue-joint-venture.html", "Vornado Realty Trust, Rudin Management, and an affiliate of Citadel founder Ken Griffin formally agreed to a joint venture")} (60% Griffin, 36% Vornado, 4% Rudin) to develop a 1.9 million-square-foot trophy tower at 350 Park Avenue, with a $6.2 billion total development budget including the $3.3 billion construction loan already reported; Citadel Enterprise Americas will take a 15-year, 1.05 million-square-foot anchor lease as its New York headquarters &mdash; one of the largest office leases in NYC history &mdash; with the JV and financing expected to close in Q3 2026.''',
         why="Formalizing the joint-venture structure and disclosing a 1.05 million-square-foot, 15-year anchor lease turns what was previously just a large construction loan into a fully specified project with known equity ownership and known leasing risk &mdash; the earlier-reported financing only made sense once this leasing and ownership structure was locked in. A record-setting anchor lease from the equity partner itself is about as strong a pre-leasing signal as ground-up trophy office construction gets in this cycle.",
         implications=[
             "Converts a previously reported construction loan into a fully specified project with known equity ownership and anchor tenancy",
             "Sets a record-scale benchmark (1.05 million square feet, 15 years) for single-tenant NYC office leases this cycle",
             "Removes most of the leasing risk on a $6.2 billion ground-up trophy tower before construction financing even closes",
             "Reinforces Park Avenue's continued strength as a location for supertall, anchor-tenant-driven office development",
         ],
         watch="Whether the JV and construction financing close on the targeted Q3 2026 timeline, and construction milestones as the 1.9 million-square-foot tower proceeds."),
    dict(category="Office", title="Extell Development Buys Office Property at 110 East 55th Street for $65M",
         subtitle="A Luxury Condo Developer's Rare Office Buy Signals Counter-Cyclical Opportunism",
         date="week of August 17, 2026",
         trigger=f'''{src("https://therealdeal.com/new-york/2026/08/18/new-york-top-real-estate-deals-monday-aug-17-2026/", "Gary Barnett's Extell Development Company spent $65 million to acquire the office property at 110 East 55th Street")} in Midtown, the most expensive commercial transaction to hit city records that reporting period.''',
         why="Extell is best known as a luxury condo developer &mdash; One57, Central Park Tower &mdash; so an office acquisition from a firm with no recent office track record is a notable signal that at least some opportunistic capital sees current Manhattan office valuations as attractive enough to justify stepping outside a sponsor's usual asset class. That's a different kind of buyer conviction than a dedicated office fund adding to an existing strategy.",
         implications=[
             "Signals a well-capitalized sponsor from outside conventional office investing sees value at current Manhattan office pricing",
             "Provides a $65 million basis for a Midtown office property, the priciest commercial trade recorded that week",
             "Raises the question of whether Extell plans to hold, reposition, or eventually convert the asset",
             "Adds to a broader pattern of counter-cyclical capital testing depressed office valuations this cycle",
         ],
         watch="Whether Extell discloses plans for the property (hold, reposition, or conversion), and if the firm pursues additional office acquisitions outside its usual condo focus."),
...
NYC_FINAL_PARAGRAPHS = [
    "This week's clearest New York story is 350 Park Avenue finally becoming a fully specified project. The construction loan reported two weeks ago now has a formalized joint-venture ownership structure and a record 1.05 million-square-foot Citadel anchor lease behind it &mdash; together, financing, ownership, and leasing risk are all now accounted for on one of the largest ground-up office developments in the city.",
    "Snap Inc.'s Penn 2 sublease and the NBCUniversal renewal, both still fresh from prior weeks, continue to confirm Manhattan sublease supply is tightening toward 2019 levels. Extell's rare office acquisition at 110 East 55th Street adds a different kind of conviction signal: a sponsor with no recent office track record stepping outside its usual luxury-condo lane to buy at current Manhattan office pricing.",
    "The Ackman Oxman Institute purchase and the Longfellow/Sculptor life-sciences sale in Long Island City remain this cycle's clearest evidence that lab-space demand is broadening across submarkets and buyer types, while Barry Gosin's departure after 47 years atop Newmark is a reminder that leadership and firm structure are their own category of signal for anyone tracking the industry's power structure.",
]
NYC_FINAL_BULLETS = [
    "A formalized JV and a record 1.05M-SF Citadel anchor lease turned 350 Park Avenue's construction loan into a fully specified project",
    "A nearly two-decade sublease commitment at Penn 2 confirms Manhattan sublease supply is tightening toward a 2019 low",
    "A luxury condo developer with no recent office track record bought a Midtown office building, the priciest trade recorded that week",
...
CRE_NYU_BLOCK = market_block_html(
    "cre", "nyu", False, "CRE", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "JULY 28&ndash;AUG 18, 2026",
...
UGA_SNAPSHOT = [
    ...
    ("Office Pipeline", "stable"),
    ("Industrial Momentum", "rising"),
    ("Multifamily Activity", "rising"),
    ("Capital Availability", "stable"),
    ("Infrastructure Relevance", "rising"),
]

UGA_SIGNALS = [
    dict(category="Mixed-Use", title="Alpharetta Approves Jamestown's North Point Mall Redevelopment, Anchored by an NHL Arena Bid",
         subtitle="A Mall-to-Mixed-Use Conversion Is Explicitly Pitched as Bait for a Third Atlanta NHL Franchise",
         date="August 6, 2026",
         trigger=f'''{src("https://atlanta.urbanize.city/post/north-point-mall-development-jamestown-alpharetta-nhl-hockey-plan-approval", "Alpharetta's Planning Commission approved Jamestown's redevelopment plan for North Point Mall in a 4-3 vote")}, with mall owner New York Life as co-sponsor; the roughly 100-acre plan includes about 1,400 for-rent multifamily units, 700 hotel rooms, a 20,000-seat NHL-ready arena, a 4,000-seat music venue, a conference center, a movie theater, and a MARTA bus rapid transit connection, with HKS Architects designing. One City Council vote remains before final entitlements.''',
         why="Explicitly pitching a mall redevelopment's arena component as bait for a third Atlanta NHL franchise is an unusually direct entitlement strategy &mdash; Jamestown and New York Life are betting that sports-league interest, not just retail or residential demand, is what makes this specific redevelopment pencil at this scale. A split 4-3 planning commission vote also shows this wasn't a rubber-stamp approval, and one more City Council vote stands between this plan and full entitlement.",
         implications=[
             "Ties a roughly 100-acre mall redevelopment's economics directly to landing a third Atlanta NHL franchise",
             "Adds up to 1,400 multifamily units and 700 hotel rooms to North Fulton County's development pipeline if approved",
             "Signals continued institutional conviction (Jamestown, New York Life) in mall-to-mixed-use conversion at scale",
             "Leaves one more City Council vote before the plan is fully entitled",
         ],
         watch="The outcome of the City Council's August 24 vote, and whether an NHL franchise bid materializes to justify the arena component."),
    dict(category="Office", title="Regent Partners in Talks to Buy Distressed Tower Place 100 in Buckhead",
         subtitle="A Starwood Default Sets Up a Value-Add Trade at Roughly Half the Tower's 2018 Valuation",
         date="July 23, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/deal-sheet/regent-partners-in-talks-to-buy-tower-place-100-135548", "Regent Partners, with Morning Calm Management, is negotiating to acquire the 639,000-square-foot, 29-story Tower Place 100")} at 3340 Peachtree Road in Buckhead from Starwood Capital, which defaulted on its $212.5 million mortgage in 2023 after buying the tower for $192 million in 2015; the deal is reportedly financed with up to $124 million in debt and remains in due diligence. The 65%-leased building's valuation fell from $277 million in 2018 to $153 million in 2021.''',
         why="A tower that lost more than 40% of its valuation between 2018 and 2021, now trading hands after a lender-driven default, is a specific, quantified data point on how much value Buckhead's office market has actually shed since its pre-pandemic peak &mdash; a value-add buyer stepping in at this basis is betting that repositioning and lease-up can recover value the market alone hasn't restored.",
         implications=[
             "Provides a quantified valuation decline (roughly 45% from 2018 to 2021) for a specific Buckhead office trophy",
             "Signals value-add buyers are willing to underwrite distressed Buckhead office at a steep discount to peak pricing",
             "Tests whether repositioning capital can recover value a soft office market alone hasn't restored",
             "Adds a real basis comp for other distressed Buckhead office towers still working through lender-driven processes",
         ],
         watch="Whether Regent Partners closes the acquisition, and any disclosed repositioning or leasing strategy for the 65%-leased tower."),
    dict(category="Office", title="Argenbright Group Relocates HQ to One Alliance Center, Expanding Footprint",
         subtitle="A Flight-to-Quality Tenant Move Shows Buckhead Class-A Leasing Still Active Amid the Distress",
         date="July 9, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/deal-sheet/security-firm-moving-to-one-alliance-center-the-atlanta-deal-sheet-135371", "Security and facilities firm Argenbright Group is relocating its headquarters from Salesforce Tower to One Alliance Center")}, a 550,000-square-foot Class A Buckhead building owned by Highwoods Properties, expanding to more than 23,000 square feet from 15,000 square feet at its prior location; Highwoods has filed renovation plans for the buildout.''',
         why="A tenant expanding its footprint while relocating between two Class A Buckhead buildings, rather than shrinking or leaving the submarket, is a concrete flight-to-quality data point that runs alongside this week's distressed Tower Place 100 story &mdash; Buckhead's office market is bifurcating by asset quality and landlord execution, not uniformly declining, and active leasing brokerage (JLL, NAI Brannen Goddard) is still working real deals in the submarket.",
         implications=[
             "Confirms Buckhead Class A leasing remains active even as other towers in the same submarket face default",
             "Adds a real, expanding tenant commitment to Highwoods Properties' One Alliance Center",
             "Signals landlord-funded renovation capital is still being deployed to win flight-to-quality tenants in Buckhead",
             "Provides evidence Buckhead office distress is asset-specific, not submarket-wide",
         ],
         watch="Whether Highwoods signs additional flight-to-quality tenants at One Alliance Center following the Argenbright relocation."),
    dict(category="Multifamily", title="Alta Porter Brookhaven Apartments Sell for $101M, One of 2026's Top Per-Unit Trades",
         subtitle="Institutional Capital Still Pays Up for Recently-Delivered, Well-Located Atlanta Multifamily",
         date="July 16, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/multifamily/brookhaven-apartment-sale-highlights-institutional-desire-prime-atlanta-properties-135439", "Wood Partners sold the 291-unit Alta Porter apartment complex, plus 17,500 square feet of retail, in Brookhaven for $101 million")} to New Orleans-based Key Real Estate; the property was originally financed with a $44.6 million Fannie Mae loan in 2020, and the sale is cited as one of the highest per-unit multifamily trades in metro Atlanta so far in 2026.''',
         why="A top-of-market per-unit trade for a recently-delivered, well-located Brookhaven asset confirms core-plus multifamily investment demand remains strong for the right product, even as older or less-located Atlanta multifamily assets show real distress elsewhere on this desk &mdash; underwriting in this market is tracking asset quality and location as much as broad market sentiment.",
         implications=[
             "Sets one of 2026's highest per-unit multifamily benchmarks for the metro Atlanta market",
             "Confirms institutional buyer (Key Real Estate) appetite for recently-delivered, well-located Atlanta multifamily",
             "Provides a comp for comparable Brookhaven-area core-plus apartment assets considering a sale",
             "Reinforces that Atlanta multifamily underwriting is tracking asset quality more than broad market sentiment",
         ],
         watch="Whether comparable recently-delivered Atlanta-area multifamily assets trade at similarly strong per-unit pricing."),
    dict(category="Multifamily", title="Generation Atlanta Apartment Tower Sells for $98.4M After Foreclosure",
         subtitle="A Downtown Tower's Value Fell From $127M in 2021 to a Below-Loan-Balance Sale in 2026",
         date="August 4, 2026",
         trigger=f'''{src("https://www.bisnow.com/atlanta/news/capital-markets/investor-pays-98m-for-foreclosed-downtown-atlanta-apartment-tower", "New York's Saratoga Capital Partners bought the 336-unit Generation Atlanta tower")} at 369 Centennial Olympic Park Drive for $98.4 million from lender affiliate Generations Property Owner, after original owner Frankforter Group defaulted on a $104.4 million loan originated by Arbor Realty Trust; the tower traded for nearly $127 million in 2021, and the deal includes a pending requirement to convert 66 units to affordable housing under a 2025 tax-allocation-district grant.''',
         why="A downtown Atlanta apartment tower selling below its original 2021 purchase price, and below the loan balance that financed it, is a concrete, quantified data point on downtown multifamily value erosion &mdash; the completed foreclosure-to-sale cycle here (not just a default notice) shows exactly what real, closed pricing looks like once a distressed downtown Atlanta apartment asset actually changes hands.",
         implications=[
             "Provides a real, closed sale price (not just a default notice) quantifying downtown Atlanta multifamily value erosion",
             "Confirms the tower traded below both its 2021 purchase price and the loan balance that financed it",
             "Marks Saratoga Capital Partners' first urban Atlanta acquisition, adding a new institutional buyer to the market",
             "Attaches a 66-unit affordable-housing conversion requirement tied to a 2025 tax-allocation-district grant",
         ],
         watch="Saratoga's repositioning plans for the tower, and progress on the required affordable-unit conversion."),
    dict(category="Industrial", title="LM Real Estate Partners Buys Smyrna Flex Warehouse for $27M",
         subtitle="A ~44% Gain Since 2021 Reflects a Broader Metro Atlanta Industrial Sales Rebound",
         date="August 4, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/industrial/new-york-outfit-buys-smyrna-flex-warehouse", "A New York investor, LM Real Estate Partners, bought a 154,000-square-foot flex/industrial warehouse")} at 5000 Highlands Parkway in Smyrna for $27 million (roughly a 7% cap rate), financed with a roughly $20 million BankUnited loan maturing 2030; seller Berkeley Partners realized a 44% gain from its $18.75 million purchase price in 2021, with tenants including 3M, Lectra North America, and StreamLabs Water.''',
         why="A 44% gain on a shallow-bay flex/industrial asset since 2021 is a real, quantified data point confirming metro Atlanta warehouse and distribution sales are genuinely rebounding, not just recovering on paper &mdash; Bisnow cited metro-wide warehouse and distribution sales reaching $2.3 billion in H1 2026, up 83% year-over-year, and this specific trade is a concrete example of that broader trend.",
         implications=[
             "Confirms a real, quantified 44% seller gain on shallow-bay Atlanta industrial since 2021",
             "Adds a specific comp to a broader metro Atlanta industrial sales rebound (H1 2026 volume up 83% year-over-year)",
             "Signals out-of-state investors (LM Real Estate Partners) are actively targeting Atlanta flex/industrial product",
             "Provides a roughly 7% cap rate benchmark for comparable shallow-bay Atlanta industrial trades",
         ],
         watch="Whether comparable Atlanta-area flex/industrial assets continue trading at similar cap rates as the broader rebound continues."),
    dict(category="Industrial", title="Amazon Eyes 1.2M-SF Distribution Center in McDonough",
         subtitle="The Metro's Largest 2026 Industrial Lease Lands in an Exurban Henry County Submarket",
         date="reported July 31, 2026",
         trigger=f'''{src("https://www.ajc.com/business/2026/07/atlanta-warehouses-boomed-after-covid-then-cooled-theyre-hot-again/", "Amazon confirmed it is in early planning for a roughly 1.2 million-square-foot distribution center in McDonough")}, developed by PNK Group, described as the largest industrial lease in metro Atlanta so far in 2026; the news lands amid a broader industrial rebound, with H1 2026 posting more positive absorption than all of 2025 and vacancy easing toward historic norms near 9% after peaking well above it.''',
         why="A 1.2 million-square-foot e-commerce distribution lease is a bellwether-scale data point for industrial fundamentals, and Amazon specifically choosing exurban Henry County over closer-in submarkets confirms where this cycle's biggest boxes are actually landing &mdash; big-box leasing decisions like this one are exactly what drives the metro-wide absorption and vacancy improvement cited in the same report.",
         implications=[
             "Marks the largest disclosed metro Atlanta industrial lease so far in 2026",
             "Confirms exurban Henry County specifically as where this cycle's largest big-box industrial leases are landing",
             "Contributes directly to metro-wide absorption running ahead of all of 2025's total in just the first half of 2026",
             "Signals continued e-commerce distribution demand even as broader industrial narratives elsewhere describe oversupply",
         ],
         watch="Whether Amazon formalizes the lease and construction timeline, and if comparable large e-commerce leases follow in exurban Atlanta submarkets."),
    dict(category="Infrastructure", title="Microsoft Moves to Undo Its Own Local Data Center Tax Breaks",
         subtitle="A Hyperscaler Voluntarily Surrenders Incentives Amid Community Pushback",
         date="August 7, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/data-center/microsoft-seeks-to-undo-local-tax-incentives-for-data-center-projects-in-georgia", "Microsoft is asking Fulton and Douglas County development authorities to walk back property tax abatements")} it previously secured for data center projects in East Point, Palmetto, and Douglasville, following a January 2026 pledge to &ldquo;pay its own way&rdquo; amid public backlash over its Georgia data center footprint; Fulton County commissioners have separately passed a nonbinding resolution opposing further data center tax breaks.''',
         why="A hyperscaler voluntarily surrendering incentives it already won, rather than being forced to by legislation, is a rare and directly relevant signal for anyone tracking the entitlements and incentives side of data center site selection &mdash; it suggests community and political pushback on tax abatements has grown intense enough that even the beneficiary sees more long-term value in giving them up than in keeping the political fight alive.",
         implications=[
             "Marks a rare instance of a hyperscaler voluntarily surrendering data center tax incentives rather than being forced to",
             "Signals community and political pushback on data center tax abatements has reached a genuine inflection point in metro Atlanta",
             "Adds Fulton County's nonbinding anti-incentive resolution as a policy signal for future data center site selection",
             "Directly relevant to students tracking the entitlements/incentives side of the fast-growing data center CRE subsector",
         ],
         watch="Whether other hyperscalers with Georgia data center incentives follow Microsoft's lead, and how county authorities respond to the incentive-abatement request."),
]

UGA_FINAL_PARAGRAPHS = [
    "Welcome to the first issue of CRE Signal's Atlanta coverage, launched for UGA-area recruiting. This inaugural issue spans about six weeks of real, dated activity rather than one, since the market has no prior coverage to build from &mdash; and it launches into a genuinely bifurcated Buckhead office story: Regent Partners negotiating to buy the distressed, defaulted Tower Place 100 at roughly half its 2018 valuation, in the same submarket where Argenbright Group is expanding into a Class A building undergoing landlord-funded renovation.",
    "Multifamily tells a similarly split story. Alta Porter's $101 million Brookhaven sale is one of 2026's strongest metro Atlanta per-unit trades, while Generation Atlanta's foreclosure-driven sale closed below both its 2021 purchase price and its original loan balance &mdash; confirming Atlanta multifamily pricing is tracking asset quality and location far more than any single market-wide narrative.",
    "Industrial and infrastructure round out a broadly positive picture: a 44% gain on a Smyrna flex warehouse and Amazon's 1.2 million-square-foot McDonough lease both confirm a real, quantified metro Atlanta industrial rebound, while Microsoft voluntarily surrendering its own data center tax breaks is a notable data point on how intense community pushback on incentives has become.",
]
UGA_FINAL_BULLETS = [
    "A Buckhead office tower trading at roughly half its 2018 valuation and a flight-to-quality tenant expansion show the submarket bifurcating by asset quality",
    "A $101M Brookhaven multifamily sale and a foreclosure-driven downtown tower sale below loan balance show the same split in multifamily",
    "Metro Atlanta industrial sales and leasing are genuinely rebounding, confirmed by a 44% seller gain and the metro's largest 2026 lease",
    "Microsoft voluntarily surrendered its own Georgia data center tax incentives amid intensifying community pushback",
]

CRE_UGA_BLOCK = market_block_html(
    "cre", "uga", False, "CRE", "Signal", "ATLANTA, GA", "AUGUST 18, 2026", "JULY 9&ndash;AUG 18, 2026",
    UGA_SNAPSHOT, "What Happened", UGA_SIGNALS, UGA_FINAL_PARAGRAPHS, UGA_FINAL_BULLETS,
    "No predictions. No stock references. Project-anchored interpretation only.",
    implications_label="Local Market Implications",
)
...
UF_SNAPSHOT = [
    ...
    ("Office Pipeline", "rising"),
    ("Industrial Momentum", "stable"),
    ("Multifamily Activity", "stable"),
    ("Capital Availability", "stable"),
    ("Transaction Volume", "softening"),
]

UF_SIGNALS = [
    dict(category="Office", title="Miami Office Leasing Jumps Nearly 45% in Q2 2026, Pushing Rents to Records",
         subtitle="Family Offices and Financial Firms Drive the &ldquo;Wall Street South&rdquo; Migration Story Into Hard Numbers",
         date="July 1, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/07/miami-office-q2-2026-pura-vida-planet-fitness/", "Miami office leasing totaled 1.3 million square feet in Q2 2026, up nearly 45% year-over-year")}, pushing vacancy down to 14.9% and average asking rent to $67.12 per square foot ($80.85 for Class A); Peter Thiel's family office took 18,158 square feet at 830 Brickell at $250 per square foot, a Miami-Dade office rent record, while Planet Fitness leased 26,207 square feet at Omni Center and Pura Vida relocated into 26,982 square feet at Gateway at Wynwood.''',
         why="A record-setting $250-per-square-foot lease from a single family office is a specific, quantified data point on the &ldquo;Wall Street South&rdquo; migration narrative that's usually discussed qualitatively &mdash; a 45% year-over-year leasing jump, concentrated among family offices and financial firms, confirms that migration is now showing up directly in market-moving lease economics, not just headline relocation announcements.",
         implications=[
             "Sets a $250/SF Miami-Dade office rent record via a single family-office lease at 830 Brickell",
             "Confirms the Wall Street South migration narrative is showing up in real leasing volume, not just relocation headlines",
             "Pushes Miami office vacancy down to 14.9%, a tightening trend running counter to many other major US office markets",
             "Provides a $67.12/SF market-wide, $80.85/SF Class A asking-rent benchmark for the current Miami office cycle",
         ],
         watch="Whether Q3 2026 leasing data sustains the 45% year-over-year growth pace, and if additional family offices announce comparable record-rent Brickell leases."),
    dict(category="Hospitality", title="Construction Tops Out on 17-Story Grand Hyatt Miami Beach Convention Center Hotel",
         subtitle="An 800-Room Headquarters Hotel Anchors a Public-Private Convention District Bet",
         date="July 30, 2026",
         trigger=f'''{src("https://floridayimby.com/2026/07/construction-tops-out-on-17-story-grand-hyatt-miami-beach-convention-center-hotel.html", "Construction topped out on the 17-story, 800-room Grand Hyatt hotel at 1701 Convention Center Drive")}, developed by Terra and Turnberry with Arquitectonica as architect and Balfour Beatty as general contractor; the project includes 110,000 square feet of meeting and ballroom space, 17,000 square feet of ground-floor retail, and an 8,000-square-foot rooftop lawn, with completion expected in late 2027.''',
         why="An 800-room convention headquarters hotel topping out is a major, capital-intensive milestone in a public-private development category distinct from the multifamily and office deals dominating this desk elsewhere &mdash; the project's economics depend on Miami Beach's broader convention and tourism strategy succeeding, not just this single asset's own leasing or occupancy, making it a useful example of infrastructure-adjacent hospitality development.",
         implications=[
             "Marks a major construction milestone for an 800-room convention headquarters hotel anchoring Miami Beach's convention district",
             "Ties the project's ultimate success to the broader public convention and tourism strategy, not standalone hotel economics",
             "Adds 110,000 square feet of meeting/ballroom space directly serving the adjacent Miami Beach Convention Center",
             "Sets a late-2027 completion target for one of the market's largest active hospitality developments",
         ],
         watch="Construction progress toward the late-2027 completion date, and any disclosed pre-booking or convention-calendar commitments tied to the opening."),
    dict(category="Multifamily", title="Harbor Group Pays $109M for 505-Unit Emerald Palms Apartments",
         subtitle="A Near-Flat Basis Since 2021 Shows Slow Multifamily Value Appreciation in Outer Miami-Dade",
         date="August 5, 2026",
         trigger=f'''{src("https://therealdeal.com/miami/2026/08/06/south-florida-top-real-estate-deals-august-5-2026/", "Harbor Group International bought the 505-unit Emerald Palms apartment complex near Zoo Miami for $109 million")} ($215,842 per unit), spanning 34 three-story buildings on more than 28 acres at 12315 SW 151st Street; seller The Milestone Group realized only a modest roughly $2 million gain versus its 2021 purchase price.''',
         why="A large garden-style apartment complex trading at only a modest gain over its 2021 basis is a real, quantified data point on how little value outer Miami-Dade multifamily has actually appreciated over the past several years, in a market where headline rent growth narratives often suggest more &mdash; useful context for underwriting comparable garden-style assets outside the urban core.",
         implications=[
             "Provides a real, quantified data point (roughly $2 million gain over five years) on slow outer-Miami-Dade multifamily appreciation",
             "Sets a $215,842-per-unit basis for large garden-style apartment complexes in the Zoo Miami/South Dade submarket",
             "Confirms institutional buyer (Harbor Group) appetite for stabilized outer-Miami-Dade multifamily despite slow appreciation",
             "Offers a useful counterpoint to more headline-driven Miami rent-growth narratives",
         ],
         watch="Whether comparable outer-Miami-Dade garden-style multifamily assets trade at similarly modest gains over their prior-cycle basis."),
    dict(category="Mixed-Use", title="Moishe Mana's Mana Common Buys Former Downtown Miami Post Office for $20.3M",
         subtitle="A Prolific Land Assembler Keeps Adding to His Downtown Miami Holdings",
         date="August 11, 2026",
         trigger=f'''{src("https://therealdeal.com/miami/2026/08/12/south-florida-top-real-estate-deals-august-11-2026/", "Moishe Mana's Mana Common bought the five-story, 35,600-square-foot former downtown Miami post office")} at 100 NE First Avenue, plus an adjacent 15,000-square-foot vacant lot at 54 NE 2nd Street, for $20.3 million from affiliates of Miami-based Stambul.''',
         why="Mana Common's continued, patient assemblage of downtown Miami real estate &mdash; buying both a historic building and an adjacent vacant lot in the same transaction &mdash; is a recognizable land-banking strategy distinct from the yield-driven institutional trades elsewhere on this desk, useful for students studying how long-horizon private capital assembles large urban land positions parcel by parcel over many years.",
         implications=[
             "Extends Moishe Mana's long-running, patient downtown Miami land assemblage strategy with another historic building",
             "Pairs a building acquisition with an adjacent vacant lot, consistent with a multi-parcel land-banking approach",
             "Provides a $20.3 million comp for comparable downtown Miami historic office/mixed-use buildings",
             "Illustrates a land-banking investment strategy distinct from the yield-driven institutional trades elsewhere in this market",
         ],
         watch="Whether Mana Common discloses redevelopment plans for the combined post office and adjacent lot site."),
    dict(category="Mixed-Use", title="Trump Group-Affiliated Entity Sells Miami Beach Office-Retail Building for $31.5M",
         subtitle="A Recognizable South Florida Buyer Picks Up South Beach Mixed-Use From a Name-Brand Seller",
         date="August 4, 2026",
         trigger=f'''{src("https://therealdeal.com/miami/2026/08/13/south-florida-top-real-estate-deals-august-12-2026/", "A Trump Group-affiliated entity sold 61,000 square feet of office and retail space at 404 Washington Avenue in Miami Beach")} for $31.5 million to prominent South Florida investor Robert Rivani, the priciest recorded South Florida commercial sale that week.''',
         why="Robert Rivani is a name recruiters will hear repeatedly across South Florida retail and mixed-use deal coverage, so a buyer this active picking up a South Beach office-retail building from a name-brand seller is a useful entry point for students learning who the recurring, deal-active buyers are in this specific market segment, distinct from the institutional funds dominating other desks.",
         implications=[
             "Adds a recognizable, repeat South Florida buyer (Robert Rivani) to a South Beach office-retail acquisition",
             "Provides a $31.5 million basis for comparable South Beach mixed-use office-retail buildings",
             "Was the priciest recorded South Florida commercial sale in its reporting week",
             "Signals continued name-brand private capital activity in South Beach mixed-use product specifically",
         ],
         watch="Whether Rivani discloses repositioning or leasing plans for the 404 Washington Avenue property."),
    dict(category="Industrial", title="Hialeah Warehouse Trades for $31M as Alsco Uniforms Buys Owner-User Space",
         subtitle="An Owner-User Pays a Premium Over 2022 Pricing in One of the Country's Tightest Logistics Markets",
         date="August 13, 2026",
         trigger=f'''{src("https://therealdeal.com/miami/2026/08/14/south-florida-top-real-estate-deals-august-13-2026/", "An entity tied to Salt Lake City-based Alsco Uniforms bought a 120,700-square-foot warehouse")} at 16175 NW 49th Avenue in Hialeah for $31 million (roughly $257 per square foot) from Kurv Industrial, which had bought the property for $26.3 million in 2022.''',
         why="An owner-user paying a real premium over 2022 pricing, rather than a financial buyer underwriting a lease-up thesis, is a specific kind of demand signal &mdash; owner-users buy for operational control, not yield, so a willingness to pay up confirms genuine occupier demand for Miami-Dade industrial space in a market widely cited as one of the tightest logistics corridors in the country given its port and airport proximity.",
         implications=[
             "Confirms genuine owner-user occupier demand, not just financial-buyer speculation, in Miami-Dade industrial",
             "Provides a $257-per-square-foot, premium-to-2022-basis benchmark for comparable Hialeah warehouse trades",
             "Reinforces Miami-Dade's position as one of the tightest logistics markets nationally given port and airport proximity",
             "Adds Alsco Uniforms as a new owner-occupier in the Hialeah industrial submarket",
         ],
         watch="Whether comparable owner-user industrial trades in Hialeah and nearby submarkets continue clearing at similar per-square-foot premiums."),
    dict(category="Market Report", title="South Florida Commercial Sales Volume Falls 13% in H1 2026 Despite Nation-Leading Construction",
         subtitle="Miami-Dade Sales Dropped 28% Even as the Region Leads the US in Multifamily and Office Construction",
         date="July 14, 2026",
         trigger=f'''{src("https://www.miamirealtors.com/2026/07/14/south-florida-is-experiencing-the-most-intense-multifamily-and-office-construction-in-the-nation/", "South Florida commercial sales totaled $5.42 billion in H1 2026, down 13% year-over-year")}, with Miami-Dade alone falling 28% to $2.05 billion, per MIAMI REALTORS Chief Economist Gay Cororaton; median price per square foot across core asset classes rose 1% to $330, with office up 12%, industrial up 7%, retail up 24%, and multifamily down 3% &mdash; even as the report describes South Florida as experiencing the most intense multifamily and office construction relative to existing stock in the nation.''',
         why="A market that's simultaneously seeing sales volume fall and construction activity lead the nation is a genuinely bifurcated signal worth sitting with directly &mdash; falling transaction volume doesn't necessarily mean falling conviction, since developers are still building at a nation-leading pace relative to existing stock even as fewer existing assets change hands, a distinction worth understanding before citing either statistic alone in an interview.",
         implications=[
             "Confirms Miami-Dade transaction volume fell sharply (28%) even as the broader region leads the nation in construction intensity",
             "Provides asset-class-level price-per-square-foot trends (office +12%, retail +24%, multifamily -3%) for macro framing",
             "Shows falling transaction volume and rising construction activity coexisting rather than contradicting each other",
             "Offers a citable macro data point for framing any individual South Florida deal against the broader 2026 market",
         ],
         watch="Whether H2 2026 transaction volume data shows the 13% decline stabilizing or continuing, and how construction completions affect asset-class pricing trends."),
]

UF_FINAL_PARAGRAPHS = [
    "Welcome to the first issue of CRE Signal's Miami coverage, launched for UF-area recruiting. This inaugural issue spans about seven weeks of real, dated activity rather than one, and it launches into a genuinely bifurcated market: Miami office leasing jumped nearly 45% year-over-year in Q2, led by a record $250-per-square-foot family-office lease at 830 Brickell, even as South Florida-wide commercial sales volume fell 13% and Miami-Dade specifically fell 28% over the same stretch.",
    "That same bifurcation shows up asset by asset. Harbor Group's near-flat-basis purchase of Emerald Palms confirms slow multifamily appreciation in outer Miami-Dade, while Alsco Uniforms paying a real premium over 2022 pricing for a Hialeah warehouse confirms genuine owner-user industrial demand in one of the tightest logistics markets in the country &mdash; the same market can show soft multifamily pricing and strong industrial conviction simultaneously.",
    "Moishe Mana's continued downtown land assemblage and Robert Rivani's South Beach acquisition both illustrate a distinct category of active South Florida private capital worth knowing by name, while the Grand Hyatt Miami Beach topping out is this market's clearest large-scale, public-private hospitality development milestone.",
]
UF_FINAL_BULLETS = [
    "Miami office leasing jumped nearly 45% year-over-year in Q2, led by a record $250/SF family-office lease at 830 Brickell",
    "South Florida commercial sales volume fell 13% in H1 2026 (Miami-Dade down 28%) even as the region leads the nation in construction",
    "An owner-user paid a real premium over 2022 pricing for Hialeah industrial space, confirming genuine occupier demand",
    "An 800-room convention headquarters hotel topped out, anchoring Miami Beach's public-private convention district strategy",
]

CRE_UF_BLOCK = market_block_html(
    "cre", "uf", False, "CRE", "Signal", "MIAMI, FL", "AUGUST 18, 2026", "JULY 1&ndash;AUG 18, 2026",
    UF_SNAPSHOT, "What Happened", UF_SIGNALS, UF_FINAL_PARAGRAPHS, UF_FINAL_BULLETS,
    "No predictions. No stock references. Project-anchored interpretation only.",
    implications_label="Local Market Implications",
)
...
REPE_SIGNALS = [
    ...
    dict(category="REIT Take-Private", title="H&amp;R REIT to Be Broken Up in C$6.7B Transaction, Blackstone Takes Industrial Assets",
         subtitle="A Consortium Cherry-Picks Asset Classes Rather Than Buying the Whole Company",
         date="August 11, 2026",
         trigger=f'''{src("https://www.newswire.ca/news-releases/h-amp-r-reit-to-be-acquired-in-6-7-billion-transaction-898751585.html", "H&amp;R REIT entered an arrangement agreement to be split up in a roughly C$6.7 billion transaction")}: GO Residential REIT takes the residential and mixed-use assets, with H&amp;R unitholders ending up owning roughly 66.9% of pro forma GO REIT, while a consortium of Blackstone Real Estate, Crestpoint Real Estate Investments, and PSP Investments buys out H&amp;R's Canadian industrial portfolio; H&amp;R unitholders receive $4.28 per unit in cash plus 0.5688 GO REIT units, a 14.5% premium to the unaffected price, with the deal expected to close in Q4 2026.''',
         why="A public REIT breakup where sponsors cherry-pick specific asset classes, rather than one buyer acquiring the whole company, shows how consortium bids get structured around asset-type expertise &mdash; Blackstone is taking only the industrial portfolio it wants, while the residential and mixed-use assets flow into a separate vehicle unitholders retain exposure to. That structure lets each participant underwrite only the collateral type it knows best, rather than diluting the bid across a diversified portfolio.",
         implications=[
             "Demonstrates how PE sponsors structure consortium bids around specific asset-class expertise rather than buying a whole diversified REIT",
             "Gives H&amp;R unitholders continued exposure to residential/mixed-use assets via pro forma GO REIT ownership rather than a full cash-out",
             "Adds a meaningful Canadian industrial portfolio to Blackstone's real estate platform",
             "Sets a 14.5% premium benchmark for comparable diversified-REIT breakup transactions",
         ],
         watch="Unitholder and regulatory approval progress toward the targeted Q4 2026 close, and how pro forma GO REIT trades once the residential/mixed-use spinoff is complete."),
    ...
    dict(category="Fundraising", title="1789 Capital Closes Debut $1.2B Real Estate Development Fund",
         subtitle="A New, Politically-Connected Sponsor Enters Institutional Real Estate at Meaningful Scale",
         date="August 13, 2026",
         trigger=f'''{src("https://www.wboc.com/online_features/press_releases/1789-capital-closes-inaugural-1-2-billion-aum-real-estate-development-fund/article_06816b3e-f2eb-599d-9b48-934009eae4fb.html", "1789 Capital closed its debut real estate development fund at $1.2 billion in AUM")}, targeting Sun Belt markets (Florida, Texas, Tennessee, Georgia, and the Carolinas) across housing, manufacturing, and data-center-adjacent infrastructure, with projected total capitalization exceeding $8 billion across projects; Easton Street Capital is the fund's exclusive operating partner.''',
         why="A new entrant closing a $1.2 billion debut fund, with a stated path to more than $8 billion in total project capitalization through leverage and co-investment, is a meaningful new platform to track regardless of its backers &mdash; the Sun Belt housing, manufacturing, and data-center-adjacent focus mirrors exactly where the largest flagship sponsors are already deploying capital, suggesting the thesis has broad enough conviction to support new entrants, not just incumbents.",
         implications=[
             "Adds a new, meaningfully sized entrant to Sun Belt-focused real estate development fundraising",
             "Targets a projected total capitalization exceeding $8 billion once leverage and co-investment are layered on the $1.2 billion equity base",
             "Confirms housing, manufacturing, and data-center-adjacent infrastructure remain the consensus Sun Belt investment thesis",
             "Uses an exclusive operating-partner structure (Easton Street Capital) rather than building in-house development capability",
         ],
         watch="1789 Capital's initial deployment pace and specific project announcements across its five targeted Sun Belt states."),
    dict(category="Fundraising", title="Machine Investment Group Hits Hard-Cap on $470M Second Opportunistic Fund",
         subtitle="A Hard-Cap Close Signals Strong LP Demand for Distressed and Special-Situations Strategies",
         date="August 17, 2026",
         trigger=f'''{src("https://www.perenews.com/equity/machine-investment-group-hits-hard-cap-on-second-opportunistic-fund/", "New York-based Machine Investment Group closed its second opportunistic fund at hard-cap")}, raising $350 million plus $120 million in co-investment commitments (roughly $470 million total), targeting opportunistic, distressed, and special-situations real estate across the US.''',
         why="A hard-cap close &mdash; meaning the manager could have raised more but chose to stop at its self-imposed ceiling &mdash; is a stronger demand signal than simply hitting a target, since it shows LP interest exceeded what the manager was willing to deploy responsibly. That kind of demand for distressed and special-situations strategies specifically suggests institutional investors see this point in the cycle as attractive for opportunistic capital.",
         implications=[
             "Confirms LP demand for distressed/special-situations real estate strategies exceeded the manager's self-imposed fund ceiling",
             "Provides a $470 million total-commitment benchmark for a mid-sized opportunistic manager's second fund",
             "Signals institutional investors see the current point in the cycle as attractive for distressed and special-situations capital",
             "Adds Machine Investment Group to the roster of managers successfully raising second funds in this strategy",
         ],
         watch="Machine Investment Group's deployment pace out of the new fund, and whether it returns to market for a larger third vehicle given the hard-cap demand."),
    dict(category="Fundraising", title="Canyon Partners Closes $570M Debut Opportunistic Equity Fund, Beating Target",
         subtitle="A Credit-Focused Shop Diversifies Into Opportunistic Equity as Debt-Fund Competition Intensifies",
         date="August 10, 2026",
         trigger=f'''{src("https://www.canyonpartners.com/canyon-partners-surpasses-500-million-target-for-opportunistic-real-estate-strategy/", "Dallas-based Canyon Partners closed its first fund in a new opportunistic equity series")}, the Canyon US Real Estate Opportunity Fund (CREOF), at $570 million in commitments versus a $500 million target, targeting acquisitions, recapitalizations, distressed situations, and value-add repositioning; the firm had previously run only real estate debt funds since 2021.''',
         why="A credit-focused shop launching its first opportunistic equity vehicle, and beating its fundraising target in the process, is a useful example of how sponsors diversify their strategy mix as competition intensifies within any single lane &mdash; Canyon built its real estate track record entirely in debt since 2021, so LPs backing this equity pivot are underwriting the firm's broader distressed-market judgment, not a multi-cycle equity track record.",
         implications=[
             "Confirms LPs will back a credit-focused manager's pivot into opportunistic equity based on broader distressed-market judgment",
             "Beat its $500 million target, a positive demand signal for a debut vehicle in a new strategy for the firm",
             "Signals continued sponsor diversification into adjacent strategies as competition intensifies within established lanes",
             "Adds Canyon Partners to the roster of credit-first managers expanding into real estate equity investing",
         ],
         watch="Canyon's initial equity deployment pace and specific acquisition or recapitalization targets under the new CREOF vehicle."),
]

REPE_FINAL_PARAGRAPHS = [
    "This week's clearest REPE story is a public REIT breaking apart along asset-class lines: H&amp;R REIT's roughly C$6.7 billion split sends its Canadian industrial portfolio to a Blackstone-led consortium while residential and mixed-use assets flow into a separate spinoff, a structure that lets each participant underwrite only the collateral type it knows best rather than diluting a bid across a diversified company.",
    "Fundraising dominates the rest of this issue, and it spans the full spectrum of manager scale and strategy. Starwood's record $10.2 billion flagship close sits alongside three smaller but equally telling raises: 1789 Capital's $1.2 billion debut fund, Machine Investment Group's hard-cap $470 million close, and Canyon Partners' target-beating $570 million pivot from credit into opportunistic equity &mdash; different manager types, all finding real LP demand in the same market.",
    "PCCP/Stonemont's and TPG/Redfearn's back-to-back multi-state industrial portfolio acquisitions, both still fresh from recent weeks, continue to confirm institutional capital is chasing diversified logistics platforms broadly right now, not responding to any single seller's opportunity.",
]
REPE_FINAL_BULLETS = [
    "A public REIT is breaking apart along asset-class lines, with Blackstone taking only the industrial portfolio it wants",
    "Four separate fundraises this week, from a $10.2B flagship close to a $470M hard-cap close, show real LP demand across manager scale",
    "A credit-only manager since 2021 beat its target on a debut opportunistic equity fund, diversifying beyond its original lane",
    "Two unrelated large-cap managers have now closed multi-state industrial portfolio acquisitions within the same short window",
]


REPE_PAGE = issue_page(
    "repe", False, "REPE", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "JUNE 29&ndash;AUG 18, 2026",
...
IB_SIGNALS = [
    dict(category="M&amp;A", title="Teledyne Technologies to Acquire Varex Imaging for ~$1.1B",
         subtitle="A Strategic Bolt-On in Medical Imaging Vertically Integrates X-Ray Detector Supply",
         date="August 10, 2026",
         trigger=f'''{src("https://www.nasdaq.com/press-release/teledyne-acquire-varex-imaging-corporation-2026-08-10", "Teledyne Technologies agreed to acquire Varex Imaging, a maker of X-ray tubes and photon-counting detectors")}, in an all-cash deal at $18.90 per share worth roughly $1.1 billion including equity awards and net debt; the acquisition complements Teledyne's own X-ray detector business and is the company's largest deal since its $8.2 billion FLIR Systems acquisition in 2021. Both boards approved unanimously, with close expected in early 2027.''',
         why="A strategic acquirer folding a component supplier directly into its own product line, rather than simply partnering with it, is classic vertical-integration logic in a specialized medical-imaging supply chain &mdash; Teledyne already makes X-ray detectors, so owning Varex's tube and photon-counting-detector technology outright removes a supplier relationship and captures more of the value chain in-house. That this is Teledyne's largest deal since its landmark FLIR acquisition signals real conviction in the strategic fit, not an opportunistic bolt-on.",
         implications=[
             "Vertically integrates X-ray tube and detector supply directly into Teledyne's existing medical-imaging product line",
             "Marks Teledyne's largest acquisition since its $8.2 billion FLIR Systems deal in 2021",
             "Provides a real strategic-fit case study in supply-chain vertical integration for medtech/industrials M&amp;A coverage",
             "Sets an early-2027 close timeline pending customary regulatory approval",
         ],
         watch="Regulatory review progress and integration planning as the deal moves toward its early-2027 close."),
    dict(category="M&amp;A", title="Nasdaq to Acquire LeveL Markets, the Third-Largest US Equity ATS",
         subtitle="Exchange Operators Keep Consolidating the Trading Venues They Once Only Competed Against",
         date="August 11, 2026",
         trigger=f'''{src("https://www.tradersmagazine.com/xtra/nasdaq-announces-definitive-agreement-to-acquire-level-markets/", "Nasdaq signed a definitive agreement to acquire LeveL Markets")}, the third-largest US equity alternative trading system by volume, with more than 2,500 clients and 56% year-over-year average daily volume growth in 2025; terms were not disclosed. Nasdaq had held a minority stake in LeveL since 2021, and post-close, LeveL will operate under a new Nasdaq unit, &ldquo;Digital Liquidity Networks,&rdquo; led by Roland Chai.''',
         why="An exchange operator converting a four-year minority stake into full ownership of a major alternative trading system is a continuation of the same trading-infrastructure consolidation this desk flagged with ICE's MarketAxess acquisition a few weeks back &mdash; large exchange groups increasingly want to own, not just compete with or hold a stake in, the venues that fragment equity trading volume away from their primary markets.",
         implications=[
             "Extends the broader trend of exchange operators consolidating alternative trading venues into owned infrastructure",
             "Converts a four-year minority stake (since 2021) into full ownership and a dedicated new Nasdaq business unit",
             "Adds a fast-growing ATS (56% YoY volume growth) with 2,500-plus clients directly to Nasdaq's platform",
             "Continues a pattern of market-infrastructure consolidation also visible in ICE's recent MarketAxess acquisition",
         ],
         watch="Deal terms once disclosed, and how the new Digital Liquidity Networks unit integrates LeveL's existing client relationships."),
    dict(category="Sponsor Finance", title="Blackstone's Safe Harbor Marinas to Acquire MarineMax for ~$1.5B",
         subtitle="A 96% Premium Take-Private Shows Infrastructure Capital Reaching Into Consumer Retail",
         date="August 10, 2026",
         trigger=f'''{src("https://www.businesswire.com/news/home/20260809836761/en/MarineMax-Enters-into-Definitive-Agreement-to-be-Acquired-by-Blackstone-Infrastructure-Portfolio-Company-Safe-Harbor-in-a-$1.5-Billion-All-Cash-Transaction", "MarineMax, the NYSE-listed boat retailer, agreed to be taken private by Safe Harbor Marinas, a Blackstone Infrastructure portfolio company")}, at $53.00 per share in cash (roughly $1.5 billion enterprise value), a 96% premium to MarineMax's January 30, 2026 closing price, following a competitive strategic review; Wells Fargo advised MarineMax and Evercore advised Safe Harbor, with the deal expected to close by year-end 2026 pending shareholder and regulatory approval.''',
         why="A 96% premium is an unusually steep control premium even by take-private standards, and it's being paid by an infrastructure-fund portfolio company rather than a traditional consumer-retail sponsor &mdash; Blackstone's marina platform sees enough vertical-integration value in owning boat retail alongside marina infrastructure to justify nearly doubling the pre-deal share price, a useful example of how infrastructure capital is expanding into adjacent consumer-facing businesses.",
         implications=[
             "Sets an unusually steep 96% premium benchmark for consumer-retail take-privates this cycle",
             "Shows infrastructure-fund capital (Blackstone) expanding into adjacent consumer retail via vertical integration with existing marina assets",
             "Followed a formal competitive strategic review process, with named advisors on both sides",
             "Confirms continued sponsor appetite for large all-cash take-privates even amid selective broader deal flow",
         ],
         watch="Shareholder and regulatory approval progress toward the year-end 2026 close, and how Safe Harbor integrates MarineMax's retail operations with its marina platform."),
    dict(category="DCM", title="Griffon Corporation Prices $800M Senior Notes Due 2034",
         subtitle="A Leveraged Issuer Terms Out Near-Dated Debt at a Higher Coupon in the Current Rate Environment",
         date="August 10, 2026",
         trigger=f'''{src("https://www.stocktitan.net/sec-filings/GFF/8-k-griffon-corp-reports-material-event-6583bca878db.html", "Griffon Corp priced an $800 million Rule 144A/Reg S private placement of senior unsecured notes")} due 2034 at a 6.25% coupon, refinancing its outstanding 5.750% notes due 2028; BofA Securities served as representative of the initial purchasers, with settlement expected August 18.''',
         why="Refinancing 2028-dated debt with new 2034 paper at a higher coupon (6.25% versus the retired 5.750%) is exactly the trade-off leveraged issuers accept to push out maturities in a higher-rate environment &mdash; a clean, textbook liability-management example of terming out near-dated debt before it becomes a refinancing-wall problem, even at a real cost in higher ongoing interest expense.",
         implications=[
             "Provides a clean, quantified example of an issuer trading a higher coupon for six additional years of maturity runway",
             "Removes a 2028 refinancing-wall risk from Griffon's capital structure well ahead of the actual maturity date",
             "Sets a 6.25%/2034 pricing benchmark for comparable industrial-sector high-yield refinancing issuance",
             "Reinforces BofA Securities' continued role leading leveraged-issuer 144A/Reg S note placements",
         ],
         watch="Whether other similarly rated industrial issuers pursue comparable proactive refinancings of 2027-2028-dated debt."),
    dict(category="ECM", title="Vogenx Prices IPO at $13.00/Share, Raises ~$81.3M",
         subtitle="A Smaller Biotech IPO Prices at the Top of Its Range Alongside the Larger Attovia Debut",
         date="August 11, 2026",
         trigger=f'''{src("https://www.stocktitan.net/news/VOGX/", "Clinical-stage biopharmaceutical company Vogenx priced its IPO at $13.00 per share")}, the top of its range, selling 6.25 million shares for roughly $81.3 million in gross proceeds; the stock began trading on Nasdaq under the ticker VOGX on August 12, with the offering closing August 13.''',
         why="A smaller biotech IPO pricing cleanly at the top of its range, in the same stretch as the larger Attovia Therapeutics debut, adds a second data point confirming genuine investor appetite has returned for clinical-stage healthcare names across a range of deal sizes, not just for one standout large offering.",
         implications=[
             "Adds a second clean, top-of-range biotech IPO pricing in the same window as the larger Attovia debut",
             "Confirms reopened ECM investor appetite for clinical-stage healthcare names spans a range of deal sizes",
             "Provides a $81.3 million raise benchmark for comparable smaller clinical-stage biotech IPOs",
             "Signals continued momentum in the 2026 biotech IPO recovery narrative this desk has tracked",
         ],
         watch="Vogenx's aftermarket trading performance in the weeks following its debut, relative to Attovia's stronger post-IPO pop."),
]

IB_FINAL_PARAGRAPHS = [
    "This week's dealmaking spans strategic vertical integration, market-infrastructure consolidation, and an unusually steep take-private premium. Teledyne's $1.1 billion acquisition of Varex Imaging folds a key supplier directly into its own product line, while Nasdaq's acquisition of LeveL Markets continues the same trading-infrastructure consolidation trend this desk flagged with ICE's MarketAxess deal a few weeks ago.",
    "Blackstone's Safe Harbor Marinas paying a 96% premium to take MarineMax private is this week's clearest signal of infrastructure capital reaching into adjacent consumer-facing businesses &mdash; an unusually steep control premium that reflects real vertical-integration conviction between marina infrastructure and boat retail, not just an opportunistic bid.",
    "Griffon's proactive $800 million refinancing and Vogenx's clean, top-of-range IPO round out a week where capital markets activity kept moving steadily alongside the larger headline M&amp;A, from leveraged-issuer liability management to a second consecutive strong biotech IPO print.",
]
IB_FINAL_BULLETS = [
    "Teledyne's $1.1B Varex acquisition vertically integrates X-ray detector supply directly into its existing medical-imaging line",
    "Nasdaq's acquisition of LeveL Markets continues exchange operators' consolidation of trading infrastructure they once only competed with",
    "Blackstone paid a 96% premium to take MarineMax private, an unusually steep take-private premium reflecting real vertical-integration conviction",
    "A second consecutive clean, top-of-range biotech IPO print confirms reopened ECM appetite spans a range of deal sizes",
]

IB_PAGE = issue_page(
    "ib", False, "IB", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "AUGUST 10&ndash;18, 2026",
...
CREDIT_SIGNALS = [
    ...
    dict(category="Asset-Based Lending", title="Nvidia Unveils $500B Multi-Firm AI Infrastructure Financing Framework",
         subtitle="A Chip Supplier Positions Itself as Financier, Structuring GPU-Backed Loans Toward a Tradeable Market",
         date="August 10&ndash;11, 2026",
         trigger=f'''{src("https://247wallst.com/investing/2026/08/11/live-nvidia-creates-a-500-billion-ai-financing-pool-these-stocks-could-win/", "Nvidia is working with six partner firms &mdash; Goldman Sachs, BlackRock, KKR, Blackstone, Apollo Global, and Brookfield Asset Management &mdash; to structure a $500 billion AI infrastructure financing framework")}, under which Nvidia backstops up to 25% of losses or residual value on individual projects while the six partner firms absorb the remaining 75% of lending risk, treating GPUs as collateralizable, revenue-producing infrastructure assets that could eventually be packaged into standardized, tradeable securities resembling auto-loan ABS.''',
         why="A chip supplier positioning itself as financier, alongside six of the largest asset managers and banks in the world, is a structurally different move than any single-borrower AI financing this desk has covered &mdash; Nvidia isn't just selling chips anymore, it's actively engineering the credit market that will fund their purchase, with an explicit long-term goal of turning GPU-backed loans into a standardized, tradeable asset class. That ambition, if realized, would be a genuinely new securitization category built from scratch.",
         implications=[
             "Positions Nvidia itself as a financing structurer, not just a chip supplier, alongside six major banks and asset managers",
             "Introduces a specific loss-sharing structure (Nvidia backstopping up to 25%) across all participating AI infrastructure projects",
             "States an explicit ambition to standardize GPU-backed loans into a tradeable securitized asset class, similar to auto-loan ABS",
             "Overlaps in sponsor roster (Apollo, Blackstone, BlackRock) with financings this desk has already covered, without being the same transaction",
         ],
         watch="Whether the framework produces its first standardized, rated GPU-backed security, and how the 25%/75% loss-sharing structure performs if any individual project underperforms."),
    dict(category="Asset-Based Lending", title="Northleaf Closes $450M Asset-Based Specialty Finance Fund",
         subtitle="A Concrete, Closed Fundraise Shows ABL's Reach Well Beyond AI-Chip Collateral",
         date="August 18, 2026",
         trigger=f'''{src("https://alternativecreditinvestor.com/2026/08/18/northleaf-asset-based-specialty-finance-fund-secures-450m-at-final-close/", "Northleaf closed its asset-based specialty finance fund at $450 million")} including co-investment, targeting entertainment royalties, legal assets, healthcare receivables, and factoring across the US, Canada, Europe, and Australia; the platform has now deployed roughly $1.4 billion across 21 investments since 2018, and Northleaf recently hired JD Gettmann, formerly of MidCap Financial, as Global Head of Asset-Based Specialty Finance.''',
         why="A concrete, closed fundraise targeting entertainment royalties, legal assets, and healthcare receivables is a useful counterweight to this week's AI-chip-collateral headlines &mdash; it confirms asset-based lending as a strategy is broadening across genuinely diverse, non-tech collateral types, not narrowing into a single AI-infrastructure trade.",
         implications=[
             "Confirms asset-based lending strategies are broadening into diverse, non-tech collateral types, not narrowing around AI infrastructure",
             "Extends Northleaf's specialty-finance platform to roughly $1.4 billion deployed across 21 investments since 2018",
             "Signals continued institutional talent movement into dedicated asset-based specialty finance leadership roles",
             "Provides a $450 million closed-fund benchmark distinct from the exploratory or in-talks AI-infrastructure deals covered elsewhere this cycle",
         ],
         watch="Northleaf's deployment pace across its four target collateral types, and early performance data as the platform's AUM continues scaling."),
    dict(category="BDC", title="Blackstone and Blue Owl BDCs Upsize Bond Sales in First Post-Lull Test",
         subtitle="Two Non-Traded Platforms' First Bond Issuances Since a Q3 Lull Both Cleared Well Above Target",
         date="August 17, 2026",
         trigger=f'''{src("https://www.bloomberg.com/news/articles/2026-08-17/blackstone-blue-owl-private-credit-funds-offer-high-grade-bonds", "Blackstone Private Credit Fund raised $750 million of five-year notes against a roughly $500 million target")}, and Blue Owl Technology Finance Corp priced $400 million (double its $200 million initial target) via a tap of its 6.500% notes due 2029; both were the first BDC bond issuances since a Q3 2026 lull in private-credit debt issuance.''',
         why="Two of the largest non-traded BDC platforms both significantly upsizing their first bond sales since a quarter-long issuance lull is a real test of institutional investor appetite for high-grade BDC paper &mdash; a single upsized deal could be idiosyncratic, but two independent platforms clearing well above target in the same week confirms capital-markets access has genuinely reopened for this specific corner of private credit, not just for one strong issuer.",
         implications=[
             "Confirms institutional investor appetite for high-grade BDC bonds has genuinely reopened after a Q3 issuance lull",
             "Shows two independent large-scale platforms (Blackstone, Blue Owl) both clearing well above target in the same week",
             "Provides fresh pricing benchmarks (5-year notes, a tap of existing 6.500% 2029 notes) for comparable BDC issuance",
             "Signals BDCs retain reliable public bond-market access as a funding source alongside subscription lines",
         ],
         watch="Whether other large BDC platforms follow with bond issuance in the coming weeks, confirming the reopening extends market-wide."),
    dict(category="Direct Lending", title="Partners Group Closes $1B Private Credit Mandate With Asia Investor",
         subtitle="A Major Institutional Mandate Signals Growing APAC Appetite for Direct Lending Diversification",
         date="August 17, 2026",
         trigger=f'''{src("https://alternativecreditinvestor.com/2026/08/17/partners-group-closes-1bn-private-credit-mandate-with-asia-investor/", "Partners Group closed a $1 billion open-ended, evergreen mandate for senior and junior direct lending across Asia-Pacific")} with a major Asian institutional investor, including a discretionary tranche plus co-investment capital; it follows a &euro;800 million sovereign wealth fund mandate Partners Group closed earlier in 2026.''',
         why="A second large, disclosed Asian institutional mandate in the same year, from a manager with $40 billion-plus in global private credit AUM, confirms this isn't a one-off allocation but a genuine pattern of insurer and sovereign-wealth-fund capital diversifying into APAC direct lending &mdash; useful context for students tracking how private credit's growth is extending well beyond its traditional US/Europe base.",
         implications=[
             "Confirms a repeating pattern, not a one-off, of large Asian institutional capital allocating to direct lending mandates",
             "Provides a $1 billion open-ended mandate benchmark for comparable APAC direct lending allocations",
             "Signals continued global platform growth for private credit beyond its traditional US/Europe core",
             "Adds to Partners Group's disclosed 2026 APAC fundraising alongside an earlier &euro;800 million sovereign wealth fund mandate",
         ],
         watch="Deployment pace under the new mandate, and whether Partners Group discloses additional large APAC institutional mandates later in 2026."),
    dict(category="Documentation", title="Private Credit Firms Pull Back From Payment-in-Kind Provisions",
         subtitle="PIK Usage Fell From 25% to 13.5% of New Loans in a Single Quarter, a Real Underwriting-Discipline Signal",
         date="August 11, 2026",
         trigger=f'''{src("https://www.pymnts.com/news/banking/2026/private-credit-firms-pull-back-from-payment-in-kind-perks/", "Only 13.5% of new private credit loans in Q2 2026 carried payment-in-kind provisions")}, down from 25% at the end of 2025, as lenders tighten standards amid worsening loan performance and regulatory scrutiny of loans often exceeding $80 million with limited tangible collateral; Lincoln International's Brian Garfield described it as &ldquo;an evolution we are seeing unfolding now &mdash; the pendulum is shifting.&rdquo;''',
         why="PIK usage &mdash; letting borrowers defer cash interest rather than pay it currently &mdash; has been one of the clearest hidden-stress indicators in private credit, since it lets a struggling borrower avoid a technical default without actually improving. A near-halving of PIK usage in a single quarter is a real, quantified signal that lenders are repricing risk and demanding more current-pay discipline, directly complicating any narrative that documentation quality has been one-way eroding throughout this cycle.",
         implications=[
             "Provides a real, quantified reversal (25% to 13.5% in one quarter) in a key hidden-stress indicator for private credit",
             "Signals lenders are repricing risk and demanding more current-pay discipline amid worsening loan performance",
             "Complicates any narrative that private credit documentation quality has been one-way eroding this cycle",
             "Reflects growing regulatory scrutiny specifically of loans exceeding $80 million with limited tangible collateral",
         ],
         watch="Whether the PIK pullback continues into Q3 2026 data, and how it interacts with the broader private-credit-to-bank refinancing flow this desk has tracked."),
    ...
    dict(category="Fund Finance", title="Bridgepoint Prices &euro;307M Reset of Its Debut CLO",
         subtitle="A Second Reset in a Year Extends Reinvestment to 2031 on Improved Terms",
         date="August 18, 2026",
         trigger=f'''{src("https://alternativecreditinvestor.com/2026/08/18/bridgepoint-prices-e307m-reset-of-debut-clo/", "Bridgepoint Credit priced a &euro;307.85 million reset of its debut CLO")}, extending the reinvestment period to 2031 on improved pricing terms across the capital stack; the reset follows Bridgepoint's separate &euro;405 million new-issue CLO priced in June 2026, and John Murphy, the firm's head of syndicated debt, said the reset drew strong reception from investors.''',
         why="A CLO reset priced at improved terms, extending reinvestment by several years, is a direct read on investor demand for a specific manager's paper &mdash; resets only happen on terms investors are willing to accept, so a well-received reset confirms Bridgepoint's roughly &euro;20 billion corporate-credit platform retains real credibility with CLO investors even as it separately explores a much larger secondaries sale of its private credit loan positions.",
         implications=[
             "Confirms investor demand for Bridgepoint's CLO paper specifically, distinct from its separate corporate-credit secondaries exploration",
             "Extends the CLO's reinvestment period to 2031 on improved pricing across the capital stack",
             "Adds to Bridgepoint's active 2026 CLO issuance alongside a separate &euro;405 million new-issue deal priced in June",
             "Provides a real-time barometer of investor risk appetite via reset activity, distinct from new-issue volume alone",
         ],
         watch="Whether Bridgepoint prices additional CLO resets or new-issue deals later in 2026, and how reset terms compare across managers of similar scale."),
]

CREDIT_FINAL_PARAGRAPHS = [
    "This week's signals show AI-infrastructure financing scaling from single-borrower deals into an entire proposed market structure. Apollo/Blackstone's $35 billion Anthropic financing remains this cycle's cornerstone example, but Nvidia's newly disclosed $500 billion multi-firm framework &mdash; with the chip supplier itself backstopping losses alongside six major banks and asset managers &mdash; is a structurally different ambition: standardizing GPU-backed loans into a tradeable securitized asset class from scratch.",
    "Northleaf's $450 million specialty-finance fund close is a useful counterweight to that AI-financing wave, confirming asset-based lending strategies are broadening into entertainment royalties, legal assets, and healthcare receivables, not narrowing around any single collateral type.",
    "Two data points this week point toward returning underwriting discipline: PIK usage nearly halved in a single quarter, and Blackstone and Blue Owl's BDCs both upsized their first bond sales since a Q3 lull. Read alongside Trinseo's still-escalating LME litigation and Bridgepoint's well-received CLO reset, private credit's documentation and capital-markets access both look more disciplined this week than the aggregate growth numbers alone would suggest.",
]
CREDIT_FINAL_BULLETS = [
    "Nvidia unveiled a $500 billion multi-firm framework aiming to standardize GPU-backed loans into a tradeable securitized asset class",
    "PIK provisions nearly halved in a single quarter (25% to 13.5%), a real, quantified underwriting-discipline reversal",
    "Two major BDC platforms both upsized their first bond sales since a Q3 issuance lull, confirming reopened capital-markets access",
    "A $450 million specialty-finance fund close confirms asset-based lending strategies are broadening well beyond AI-chip collateral",
]

CREDIT_PAGE = issue_page(
    "credit", False, "Credit", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "JULY 9&ndash;AUG 18, 2026",
...
AUSTIN_DEBT_SIGNALS = [
    ...
    dict(category="Acquisition Financing", title="Wells Fargo Lends $136.5M to Fund Canyon Creek's One Eleven Congress Purchase",
         subtitle="The Financing Behind This Cycle's Marquee Downtown Office Trade Surfaces Two Weeks Later",
         date="August 13, 2026",
         trigger=f'''{src("https://crenews.com/2026/08/13/wells-fargo-lends-136-5mln-to-fund-purchase-of-austin-texas-office/", "Wells Fargo Bank provided $136.5 million in mortgage financing to Canyon Creek Real Estate to help fund its acquisition of One Eleven Congress")}, the 519,959-square-foot, 30-story downtown Austin office tower Canyon Creek bought from Cousins Properties for $208 million in a deal that closed July 29; rate, loan-to-value, and maturity terms were not disclosed.''',
         why="A national bank writing a $136.5 million acquisition loan on an 84%-leased, 1980s-vintage downtown tower is a direct test of office lending appetite in a market where that kind of financing has been scarce post-COVID &mdash; the fact that Wells Fargo underwrote this specific loan, on this specific asset, is a more concrete data point than the sale price alone about whether balance-sheet lenders are willing to finance older-vintage Austin office at scale again.",
         implications=[
             "Confirms a national bank is willing to underwrite acquisition financing on an older-vintage, 84%-leased downtown Austin tower",
             "Provides the debt-side comp behind this cycle's marquee $208 million One Eleven Congress trade",
             "Signals office acquisition lending in downtown Austin is not entirely closed, even if terms remain undisclosed",
             "Gives other downtown Austin office owners a real lender (Wells Fargo) to reference when seeking comparable financing",
         ],
         watch="Whether the rate, LTV, and maturity terms surface publicly, and if Wells Fargo or other national banks underwrite comparable acquisition loans on other downtown Austin office towers."),
    ...
    dict(category="Bridge Lending", title="Benefit Street Partners Provides $103M Bridge Loan for Texas Multifamily Portfolio Including Austin Property",
         subtitle="Fresh Bridge Capital Is Still Funding Lease-Up Risk on Newer Class-A Product",
         date="August 11, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/08/benefit-street-partners-103m-texas-multifamily-portfolio/", "Benefit Street Partners provided a $103 million floating-rate, interest-only bridge loan with a three-year term to Vantage Communities")}, refinancing a three-property, 864-unit multifamily portfolio across Texas; one of the three, Vantage at McKinney Falls (288 units), is in Austin, with the other two in Hutto and Boerne. Greystone Capital Advisors arranged the transaction, structured to support the properties &mdash; all opened 2023&ndash;2024 &mdash; toward full stabilization.''',
         why="A debt-fund bridge lender financing lease-up risk on newer, recently delivered Class-A multifamily is a useful counterpoint to the maturity-wall distress dominating this desk &mdash; Benefit Street is betting these properties stabilize enough within three years to refinance into permanent debt, a fundamentally different underwriting question than the 2021-vintage bridge loans now failing to refinance elsewhere in the metro.",
         implications=[
             "Confirms debt funds remain willing to finance lease-up/stabilization risk on newer Class-A Austin-metro multifamily",
             "Provides a $103 million/864-unit benchmark spanning Austin and two adjacent suburban Texas markets",
             "Signals continued bridge-lending appetite for recently delivered product, distinct from distressed 2021-vintage loans",
             "Reinforces Greystone Capital Advisors' active role arranging Texas multifamily bridge financings",
         ],
         watch="Lease-up and stabilization progress at all three properties over the loan's three-year term, and whether Vantage Communities refinances into permanent debt before maturity."),
]

AUSTIN_DEBT_FINAL_PARAGRAPHS = [
    "This week's clearest Austin debt story is the financing behind last month's marquee office trade finally surfacing: Wells Fargo's $136.5 million acquisition loan on One Eleven Congress is the debt-side comp for Canyon Creek's $208 million purchase from Cousins Properties, and a real test of national-bank appetite for older-vintage downtown Austin office at scale.",
    "The Morgan Apartments and Line Austin, both still working through the special-servicer and foreclosure process from prior weeks, remain this cycle's clearest examples of 2021-2023-vintage floating-rate debt hitting the maturity wall across multiple property types.",
    "Benefit Street Partners' $103 million bridge loan on a three-property, Austin-inclusive multifamily portfolio is this week's counter-signal: fresh bridge capital is still funding lease-up risk on newer Class-A product, a fundamentally different underwriting bet than the maturing 2021-vintage loans now failing to refinance elsewhere in the metro.",
]
AUSTIN_DEBT_FINAL_BULLETS = [
    "The debt behind last month's marquee $208M office trade surfaced: Wells Fargo lent $136.5M to fund Canyon Creek's purchase",
    "Two downtown Austin hotels and a 504-unit apartment complex remain in various stages of foreclosure or special servicing",
    "A Freddie Mac apartment loan reset from a $50M credit bid to a $9.5M opening ask remains this cycle's hardest basis data point",
    "A debt fund still financed $103M of lease-up risk on newer Class-A multifamily, a different bet than maturing 2021-vintage bridge debt",
]


REDEBT_NATIONAL_BLOCK_ARCHIVE = market_block_html(
    "redebt", "austin", True, "RE Debt", "Signal", "AUSTIN, TEXAS", "AUGUST 18, 2026", "JUNE 2&ndash;AUG 18, 2026",
...
USC_DEBT_SIGNALS = [
    ...
    dict(category="Distressed Note Sale", title="L.A. Care in Talks to Buy Defaulted Loan on West7Center Office/Data Center",
         subtitle="A Tenant, Not a Distressed-Debt Fund, Emerges as the Preferred Buyer of Its Own Building's Note",
         date="August 12, 2026",
         trigger=f'''{src("https://therealdeal.com/la/2026/08/12/l-a-care-in-talks-to-buy-office-data-center-loan/", "Health insurer L.A. Care is in exclusive negotiations to purchase the defaulted note on West7Center")}, the office/data center building at 1200 West 7th Street in downtown LA's City West submarket; the underlying $200 million loan, originated by Brookfield and syndicated in part to a group led by Korean bank Shinhan, went into default after borrower Rising Realty Partners missed payments, with a notice of default and election to sell recorded in March. Other bidders were reportedly in the mix, including a roughly $125 million offer tied to Rising's own company, but lenders chose to negotiate exclusively with L.A. Care, which is also a tenant in the building.''',
         why="A tenant buying the defaulted note on its own building, rather than a distressed-debt fund, is a specific kind of workout resolution &mdash; L.A. Care has occupancy-driven reasons to control the asset's future that a pure financial buyer wouldn't share, which likely explains why lenders chose exclusive negotiations with L.A. Care over a lower, borrower-affiliated offer. It's also a useful illustration of how foreign bank participants (Shinhan) end up exposed to US CRE workouts through syndicated loan participations originated by a name-brand lender like Brookfield.",
         implications=[
             "Shows a tenant, not a distressed-debt fund, as the preferred buyer in a note-sale workout process",
             "Illustrates how syndicated loan participations pull foreign bank participants (Shinhan) into US CRE workouts",
             "Confirms lenders passed on a lower, borrower-affiliated offer in favor of a tenant-buyer with occupancy-driven motivation",
             "Adds another downtown LA office/data center asset to the note-sale and workout pipeline this cycle",
         ],
         watch="Whether L.A. Care's exclusive negotiations result in a closed note purchase, and the eventual price relative to the $200 million original loan balance."),
]

USC_DEBT_FINAL_PARAGRAPHS = [
    "This week's clearest Los Angeles debt story is a workout path, not a default: L.A. Care, a health insurer and existing tenant, has emerged as the preferred buyer of the defaulted note on West7Center, choosing exclusive negotiations with lenders over a lower offer tied to the original borrower. It's a clean illustration of how occupancy-driven buyers can win note-sale processes that a pure financial buyer wouldn't.",
    "Hackman Capital's Television City default and the Manhattan Beach Studios note sale remain in motion from prior weeks, and the $1.1 billion Hudson Pacific/Blackstone Sunset Studios special servicing transfer continues to confirm this wave is largely a refinancing-timing problem, not a fundamentals problem.",
    "Downtown LA office and mixed-use distress keeps generating real, comparable data points: Bank of America Plaza's crystallized $175.87 million CMBS loss and the Metropolitan Building's receivership are both still working through the special-servicer playbook, now joined by West7Center's note-sale process as a third downtown asset in active workout.",
]
USC_DEBT_FINAL_BULLETS = [
    "A tenant, not a distressed-debt fund, is the preferred buyer of the defaulted note on a downtown LA office/data center building",
    ...
    "Three Hackman-affiliated studio properties remain in distress or under new ownership from prior weeks",
    "A third downtown LA asset, West7Center, joined Bank of America Plaza and the Metropolitan Building in active workout",
]


REDEBT_USC_BLOCK = market_block_html(
    "redebt", "usc", False, "RE Debt", "Signal", "LOS ANGELES, CA", "AUGUST 18, 2026", "JULY 15&ndash;AUG 18, 2026",
...
NYC_DEBT_SIGNALS = [
    ...
    dict(category="Refinancing", title="Acadia Realty Provides $75M Loan for Whitestone Shopping Center Redevelopment",
         subtitle="A Larger Follow-On Loan Backs Redevelopment Plans at a Queens Center Bought Weeks Earlier",
         date="August 17, 2026",
         trigger=f'''{src("https://crenews.com/2026/08/17/queens-n-y-retail-property-sells-for-56mln-gets-loan-from-acadia-realty/", "An affiliate of Acadia Realty Trust committed $75 million in mortgage financing to BTF Whitestone LLC")} to fund its $56 million acquisition and planned redevelopment of the Key Food-anchored Whitestone Shopping Center in Queens, following a competitive lender process arranged by Northmarq's New York debt and equity team; the $75 million figure supersedes the roughly $48.5 million acquisition-only financing initially reported when the sale closed in July.''',
         why="A loan sized well above the property's $56 million purchase price only makes sense if it's funding redevelopment capital alongside acquisition, not just the purchase itself &mdash; the larger, later-disclosed number is a useful reminder that initial acquisition-financing figures reported at closing often understate the full capital stack once redevelopment plans and permanent financing are finalized weeks later.",
         implications=[
             "Confirms the buyer's redevelopment plans required meaningfully more capital than the initial acquisition financing alone",
             "Signals continued institutional lender (Acadia Realty) appetite for grocery-anchored Queens retail redevelopment specifically",
             "Shows initial deal-close financing figures can understate the full capital stack once redevelopment plans finalize",
             "Reinforces Northmarq's active role arranging competitive-process retail financing in the outer boroughs",
         ],
         watch="BTF Whitestone's disclosed redevelopment scope and timeline now that permanent financing is in place."),
    ...
    dict(category="Special Servicing", title="CMBS Loan Backed by Vornado/Related's 85 Tenth Avenue Sent to Special Servicing",
         subtitle="A Servicer Moves Ahead of a December Maturity, Citing Cash Flow 28% Below Underwriting",
         date="August 12, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/08/cmbs-loan-vornado-related-85-10th-avenue-sent-special-servicing/", "A $396 million CMBS loan against 85 Tenth Avenue")} &mdash; split across the DBWF 2016-85T, CD 2017-CD3, and BACM 2017-BNK3 conduits, and secured by the 633,000-square-foot Chelsea office building co-owned 50/50 by Vornado and Related &mdash; was transferred to special servicing on grounds of &ldquo;imminent default&rdquo;; Morningstar Credit says the move is an effort to get ahead of the loan's December 2026 maturity, citing 2025 cash flow running 28% below underwriting and tenant CLEAR currently in a rent-abatement period.''',
         why="A special-servicing transfer months ahead of an actual maturity date, triggered by a cash-flow shortfall rather than a missed payment, is a proactive move by the servicer and rating agency to get ahead of a problem before it becomes a default &mdash; a useful, dated example of how CMBS workout triggers can activate on performance deterioration alone, well before a loan is technically in trouble.",
         implications=[
             "Shows special servicing can activate months ahead of maturity based on cash-flow deterioration, not a missed payment",
             "Confirms even a co-owned, blue-chip-sponsor (Vornado/Related) Chelsea office asset is generating real workout risk",
             "Puts a specific tenant rent-abatement period (CLEAR) directly in the frame as a driver of loan-level distress",
             "Adds another Manhattan office CMBS loan to the pre-maturity workout pipeline heading into year-end 2026",
         ],
         watch="Whether Vornado and Related secure a modification or refinancing ahead of the December 2026 maturity, and CLEAR's status once its rent-abatement period ends."),
    dict(category="Special Servicing", title="$120M CMBS Loan on Brooklyn's 111 Livingston Street Moves to Special Servicing",
         subtitle="CMBS Office Distress Spreads Beyond Manhattan as Cash Flow Falls 75% Below Underwriting",
         date="August 13, 2026",
         trigger=f'''A {src("https://www.connectcre.com/stories/return-to-lender-week-of-august-13-2026/", "$120 million loan against 111 Livingston Street, a Brooklyn office property")} &mdash; spread across the CGCMT 2017-P7, CD 2017-CD3, and CD 2017-CD4 conduits &mdash; was moved to special servicing after a sharp drop in net cash flow, with 2025 NCF coming in 75% below underwritten levels and occupancy at just 55% as of December 2025, per Morningstar Credit.''',
         why="A 75% cash-flow shortfall against underwriting is a far steeper deterioration than the 85 Tenth Avenue transfer above, and it's happening in Brooklyn rather than Manhattan &mdash; direct evidence that CMBS office distress isn't confined to trophy Manhattan towers but is reaching outer-borough office product with materially worse fundamentals.",
         implications=[
             "Confirms CMBS office distress is spreading into outer-borough product, not staying confined to Manhattan towers",
             "Shows a 75% cash-flow shortfall and 55% occupancy driving this transfer, a steeper deterioration than comparable Manhattan cases",
             "Illustrates how DSCR and occupancy deterioration, not just missed payments, trigger CMBS special servicing transfers",
             "Adds a Brooklyn office asset to the same legacy 2017-vintage conduit distress pattern seen elsewhere this cycle",
         ],
         watch="Whether the special servicer pursues a modification or moves toward foreclosure given the severity of the cash-flow shortfall."),
    ...
    dict(category="Construction Lending", title="Vornado, Citadel, and Rudin Land Record $3.3B Construction Loan for 350 Park Avenue",
         ...
         date="August 4, 2026",
         trigger=f'''{src("https://therealdeal.com/new-york/2026/08/05/vornado-citadels-350-park-lands-record-financing/", "Ken Griffin (Citadel, 60% stake), Vornado Realty Trust (36%, closing in September), and the Rudin family (4%) locked in a $3.3 billion construction loan")}, among the largest in New York City history, to fund the planned 62-story, roughly 1.9 million-square-foot supertall office tower at 350 Park Avenue, with total project cost around $6 billion; the joint venture behind the loan was formalized the following week alongside a 1.05 million-square-foot Citadel anchor lease, and Griffin separately extended Vornado a $400 million bridge loan tied to the project.''',
         ...
         watch="Construction milestones as the 62-story tower proceeds, and disclosure of the lender group behind the $3.3 billion loan."),
]

NYC_DEBT_FINAL_PARAGRAPHS = [
    "This week's clearest New York debt story is CMBS office distress spreading in two directions at once. A $396 million loan on Vornado/Related's 85 Tenth Avenue moved to special servicing months ahead of its December maturity on a cash-flow shortfall alone, while a $120 million loan on Brooklyn's 111 Livingston Street shows the same dynamic reaching outer-borough office with a far steeper 75% cash-flow decline &mdash; distress is no longer confined to trophy Manhattan towers.",
    "SL Green's ongoing $1.77 billion refinancing attempt and the $180 million 261 Fifth Avenue forbearance, both still in motion from prior weeks, remain useful bookends on the same office-debt spectrum: one a live test of whether mega-loans can still clear the market, the other a legacy conduit loan buying time through negotiation.",
    "Vornado, Citadel, and Rudin's record $3.3 billion construction loan for 350 Park Avenue and BXP's $1.2 billion 343 Madison loan continue to confirm lenders will still fund new office supply when anchor-tenant credit and pre-leasing are strong enough, while a larger, redisclosed Acadia Realty loan on Whitestone Shopping Center is a reminder that initial deal-close financing figures often understate the full capital stack once redevelopment plans finalize.",
]
NYC_DEBT_FINAL_BULLETS = [
    "CMBS office distress is spreading beyond Manhattan: a Brooklyn office loan showed a steeper 75% cash-flow shortfall than a comparable Chelsea case",
    "A special servicer moved months ahead of a December maturity on 85 Tenth Avenue, triggered by cash flow alone, not a missed payment",
    "A $3.3 billion construction loan for 350 Park Avenue remains among the largest in New York City history",
    "A larger, redisclosed $75M loan on Whitestone Shopping Center shows initial deal-close financing figures can understate the full capital stack",
]


REDEBT_NYU_BLOCK = market_block_html(
    "redebt", "nyu", False, "RE Debt", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "JULY 28&ndash;AUG 18, 2026",
...
UGA_DEBT_SNAPSHOT = [
    ...
    ("CMBS Issuance", "stable"),
    ("Agency Multifamily Activity", "stable"),
    ("Distress / Special Servicing", "rising"),
    ("Life-Company Lending", "rising"),
]

UGA_DEBT_SIGNALS = [
    dict(category="Distress", title="Investor Pays $98.4M for Foreclosed Downtown Atlanta Apartment Tower",
         subtitle="A Lender Group Sold Below the Original Loan Balance After a Quebec Sponsor's Default",
         date="August 4, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/multifamily/investor-pays-98m-for-foreclosed-downtown-atlanta-apartment-tower", "New York's Saratoga Capital Partners bought the 336-unit Generation Atlanta tower for $98.4 million")} from lender affiliate Generations Property Owner LLC, after Quebec-based sponsor Frankforter Group defaulted on a $104.4 million loan originated by Arbor Realty Trust and a required $7.4 million liquidity covenant; the loan was later transferred to a new lender group that came to include Synovus Bank before foreclosure.''',
         why="A lender group selling a foreclosed tower for less than the original loan balance is a real, quantified workout outcome, not an estimate &mdash; the sequence here (origination, default on a liquidity covenant, transfer to a new lender group including a regional bank, foreclosure, then a discounted bulk sale) is a clean, complete case study in how a lender-driven workout actually plays out from start to finish outside the CMBS special-servicer system.",
         implications=[
             "Provides a complete, closed workout case study from origination through default to a below-loan-balance sale",
             "Shows a regional bank (Synovus) absorbed exposure through a mid-stream loan transfer before foreclosure",
             "Confirms Arbor Realty Trust-originated Atlanta multifamily debt is generating real, quantified distress",
             "Adds Saratoga Capital Partners as a new institutional owner making its first urban Atlanta acquisition",
         ],
         watch="Saratoga's repositioning plans for the tower, and whether other Arbor-originated Atlanta multifamily loans show comparable distress."),
    dict(category="Distress", title="Dewberry's Midtown Atlanta Tower Quietly Resolves $75M ACORE Capital Mortgage",
         subtitle="A Cross-Collateralized JPMorgan Loan and a Quitclaim Deed Unwind a Stuck Mortgage Without Full Disclosure",
         date="July 29, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/capital-markets/dewberrys-midtown-eyesore-quietly-resolves-75m-mortgage-135621", "Developer John Dewberry resolved a distressed $75 million ACORE Capital mortgage")} on the 446,000-square-foot Campanile Building at 14th and Peachtree in Midtown Atlanta, through a new loan of more than $59 million from JPMorgan Chase secured against other properties in Dewberry's portfolio (originated February 2026), combined with a quitclaim deed that cleared ACORE's lien; neither party would confirm exact payoff terms, and roughly $15.6 million of the original balance's disposition remains unclear.''',
         why="A workout resolved through cross-collateralization against a sponsor's other properties, plus a quitclaim deed, rather than a straightforward refinancing or sale, is a real example of how opaque distressed-debt resolutions can be in practice &mdash; the mechanics here (partial paydown, portfolio-wide collateral pledges, a title instrument used to clear a lien) are exactly the kind of workout structuring that doesn't show up in a simple maturity-default headline.",
         implications=[
             "Illustrates cross-collateralization against a sponsor's broader portfolio as a real distressed-mortgage workout tool",
             "Shows a quitclaim deed used as the specific mechanism to clear a stuck lender's lien without full public disclosure",
             "Leaves roughly $15.6 million of the original $75 million balance's disposition genuinely unclear even after resolution",
             "Provides a real-world example of how opaque distressed CRE debt workouts can be relative to headline default coverage",
         ],
         watch="Whether the remaining balance disposition becomes public, and Dewberry's plans for the long-vacant Campanile Building now that the mortgage is resolved."),
    dict(category="Distress", title="Ardent Cos. Forecloses on $46.7M Loan, Takes Back Kennesaw's Town Center at Cobb Mall",
         subtitle="A Five-Month Maturity-to-Foreclosure Timeline Shows Private Lenders Moving Fast on Distressed Retail",
         date="July 7, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/retail/beleaguered-kennesaw-regional-mall-goes-back-to-lender-135386", "An affiliate of The Ardent Cos. foreclosed on the 560,000-square-foot Town Center at Cobb mall in Kennesaw")}, taking the property back with a winning credit bid of $51.75 million after New York investor Mike Kohan's Kohan Retail Investment Group defaulted on a $46.7 million loan that matured February 15, 2026.''',
         why="A five-month gap between loan maturity and completed foreclosure is a notably fast timeline for CRE debt enforcement, and it's happening through a private balance-sheet lender rather than a CMBS special servicer &mdash; a useful, dated comp for students comparing how quickly private lenders can move on distressed retail collateral relative to the more procedurally bound CMBS special-servicing process covered elsewhere on this desk.",
         implications=[
             "Provides a fast, five-month maturity-to-foreclosure timeline benchmark for private balance-sheet lender enforcement",
             "Shows a credit bid ($51.75 million) exceeding the original loan balance ($46.7 million), an unusual foreclosure outcome",
             "Adds a distressed regional mall to Ardent Cos.' direct ownership rather than a third-party buyer's hands",
             "Offers a useful speed comparison against the more procedurally bound CMBS special-servicing process",
         ],
         watch="Ardent's disclosed repositioning or redevelopment plans for the mall now that it holds the asset directly."),
    dict(category="Refinancing", title="Portman/Blackstone JV Lands $278M Refinancing for Ten Twenty Spring Office Tower",
         subtitle="A Rare Large Office Refinancing Clears at Roughly 50% Leased in a Tough Office-Debt Environment",
         date="August 6, 2026",
         trigger=f'''{src("https://www.bisnow.com/news/atlanta/deal-sheet/portman-ten-twenty-spring-nabs-278m-refinancing", "Portman Holdings and a Blackstone affiliate refinanced their 25-story, 540,000-square-foot Midtown Atlanta office tower")} with $278 million from Eldridge Capital Management, retiring an earlier $224.2 million Goldman Sachs construction loan from April 2022 ahead of its May 2027 maturity; the tower, roughly 50% leased with tenants including EY, Reed Smith, and new HQ tenant Pinnacle Financial Partners, was refinanced by Eldridge, which had also been a co-lender on the original construction loan.''',
         why="A large office refinancing clearing successfully at only roughly 50% leased, in a rate environment where most office refinancing has been scarce, is a genuinely notable data point &mdash; the fact that the refinancing lender (Eldridge) was already a co-lender on the original construction loan also suggests continuity of relationship and existing credit familiarity mattered as much as current leasing metrics in getting this deal done.",
         implications=[
             "Confirms large office refinancing can still clear at roughly 50% leased when lender relationship continuity exists",
             "Retires a 2022-vintage Goldman Sachs construction loan more than nine months ahead of its scheduled maturity",
             "Signals Eldridge Capital Management's continued appetite for Atlanta office debt as both original co-lender and refinancer",
             "Adds Pinnacle Financial Partners' new HQ tenancy as a leasing-momentum factor supporting the refinancing case",
         ],
         watch="Whether Ten Twenty Spring's leasing percentage climbs further, and if Eldridge originates additional Atlanta office refinancings on similar relationship-driven terms."),
    dict(category="Construction Lending", title="Protective Life Finances $78M Spivey Grove Apartments in Stockbridge",
         subtitle="A Life-Insurance Balance Sheet Funds Ground-Up Suburban Atlanta Multifamily",
         date="July 30, 2026",
         trigger=f'''{src("https://www.bisnow.com/atlanta/news/deal-sheet/emory-takes-over-atlanta-proton-center-for-82m-135640", "Capital City Real Estate and CamWest Cos. closed construction financing from Protective Life Insurance Co.")} for Spivey Grove, a $78 million, 318-unit apartment development off Highway 138 in Stockbridge, in metro Atlanta; loan amount and rate were not disclosed in the deal sheet.''',
         why="A life-insurance-company balance sheet funding ground-up suburban multifamily construction is a different capital source than the banks and debt funds that dominate most construction-lending coverage &mdash; life companies typically underwrite for long-duration, conservative risk, so their willingness to fund new suburban Atlanta apartment supply is a useful signal distinct from more opportunistic bridge or bank construction capital.",
         implications=[
             "Confirms life-insurance-company balance-sheet capital remains available for suburban Atlanta ground-up multifamily",
             "Adds 318 units to the Stockbridge/southern metro Atlanta multifamily development pipeline",
             "Provides an alternative-capital-source comp distinct from bank and debt-fund construction lending",
             "Signals continued life-company conviction in suburban Atlanta multifamily despite broader construction caution",
         ],
         watch="Whether Protective Life discloses the loan amount and rate, and construction progress toward delivery."),
    dict(category="Construction Lending", title="Affinius Capital Finances $150M Hub Athens Student Housing Project",
         subtitle="A Development Loan Lands Directly Adjacent to the University of Georgia Campus",
         date="July 30, 2026",
         trigger=f'''{src("https://www.bisnow.com/atlanta/news/deal-sheet/emory-takes-over-atlanta-proton-center-for-82m-135640", "Core Spaces and Mallory &amp; Evans secured development financing from Affinius Capital")} for Hub Athens, a $150 million, 536-unit (1,656-bed) student housing project in downtown Athens, Georgia, directly adjacent to the University of Georgia campus; loan amount and terms were not disclosed, with delivery scheduled for 2028.''',
         why="A $150 million student-housing construction loan directly adjacent to UGA's own campus is about as directly relevant as CRE debt financing gets for this newsletter's UGA-area readers &mdash; specialty student-housing lending is a distinct niche from conventional multifamily construction debt, with underwriting driven by university enrollment and leasing cycles rather than general market rent growth.",
         implications=[
             "Finances 1,656 beds of new student housing directly adjacent to the University of Georgia campus",
             "Confirms specialty student-housing lenders (Affinius Capital) remain active in financing large-scale campus-adjacent development",
             "Illustrates a distinct underwriting niche (enrollment- and lease-cycle-driven) separate from conventional multifamily construction debt",
             "Sets a 2028 delivery target directly relevant to current UGA-area real estate observers",
         ],
         watch="Construction progress toward the 2028 delivery date, and whether Core Spaces/Mallory &amp; Evans pursue additional UGA-adjacent student housing financings."),
]

UGA_DEBT_FINAL_PARAGRAPHS = [
    "Welcome to the first issue of RE Debt Signal's Atlanta coverage, launched for UGA-area recruiting. This inaugural issue spans about six weeks of real, dated activity, and it opens on three distinct distress workouts: Generation Atlanta's below-loan-balance foreclosure sale, Dewberry's opaque cross-collateralized resolution of a stuck Midtown mortgage, and Ardent Cos.' unusually fast five-month foreclosure on a Kennesaw regional mall &mdash; three different lender types (a regional bank-inclusive group, a life-insurance-adjacent cross-collateralization, and a private balance-sheet lender) working through distress on three very different timelines.",
    "Portman and Blackstone's $278 million refinancing of Ten Twenty Spring is this market's clearest evidence that large office refinancing can still clear, even at only roughly 50% leased, when lender relationship continuity exists from the original construction loan.",
    "Two construction loans close out this launch issue with a genuinely direct UGA connection: Protective Life's life-company financing for suburban Stockbridge multifamily, and Affinius Capital's $150 million loan for Hub Athens, a 1,656-bed student housing project built directly adjacent to the University of Georgia campus.",
]
UGA_DEBT_FINAL_BULLETS = [
    "Three distinct distress workouts closed in Atlanta this stretch, each through a different lender type and timeline",
    "A rare large office refinancing cleared at roughly 50% leased, backed by lender relationship continuity from the original construction loan",
    "A $150M student housing construction loan is financing 1,656 beds directly adjacent to the University of Georgia campus",
    "A five-month maturity-to-foreclosure timeline on a Kennesaw mall shows private lenders moving fast on distressed retail",
]

REDEBT_UGA_BLOCK = market_block_html(
    "redebt", "uga", False, "RE Debt", "Signal", "ATLANTA, GA", "AUGUST 18, 2026", "JULY 7&ndash;AUG 18, 2026",
    UGA_DEBT_SNAPSHOT, "What Happened", UGA_DEBT_SIGNALS, UGA_DEBT_FINAL_PARAGRAPHS, UGA_DEBT_FINAL_BULLETS,
    "No predictions. No stock references. Loan-anchored interpretation only.",
)

UF_DEBT_SNAPSHOT = [
    ("CRE Lending Volume", "rising"),
    ("Construction Financing", "rising"),
    ("CMBS Issuance", "stable"),
    ("Agency Multifamily Activity", "stable"),
    ("Distress / Special Servicing", "stable"),
    ("Condo Construction Lending", "rising"),
]

UF_DEBT_SIGNALS = [
    dict(category="Special Servicing", title="Fortress Rescues St. Regis Bal Harbour Resort From Special Servicing With $263M Refi",
         subtitle="A Performing-But-Unrefinanceable Loan Gets Recapitalized After Nearly a Year in Workout",
         date="August 14, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/08/st-regis-bal-harbour-resort-fortress-al-rayyan-tourism-investment-company-artic-florida/", "Fortress Investment Group provided $263 million in total financing")} &mdash; $188 million assuming the existing CMBS debt plus $70 million in new capital &mdash; to recapitalize the St. Regis Bal Harbour Resort, a 213-room oceanfront hotel owned by Al Rayyan Tourism Investment Company; the original loan had sat in special servicing for nearly a year after maturity despite the property remaining current and cash-flow positive, with 2024 cash flow having fallen to roughly half of 2021 levels.''',
         why="A loan that stayed current on payments yet still sat in special servicing for nearly a year is a textbook &ldquo;performing but can't refinance&rdquo; maturity default &mdash; the borrower wasn't in operational trouble, it simply couldn't find replacement capital at the loan's maturity in a tighter rate environment. Fortress stepping in with fresh capital to resolve that specific gap is exactly the kind of special-servicing resolution CRE debt shops and distressed-debt funds study closely.",
         implications=[
             "Provides a clean, textbook example of a performing-but-unrefinanceable maturity default resolved via new capital",
             "Confirms cash flow at a trophy oceanfront resort fell roughly 50% from 2021 to 2024 even while remaining current on debt service",
             "Shows Fortress willing to both assume existing CMBS debt and inject new capital in a single recapitalization",
             "Resolves a workout that had sat in special servicing for nearly a full year post-maturity",
         ],
         watch="Whether the recapitalized capital structure supports a stabilization in cash flow, and if Fortress pursues additional South Florida hospitality recapitalizations."),
    dict(category="Refinancing", title="Valley National Bank Refinances Park Towers Multifamily at 6.09% Fixed",
         subtitle="A Rare Disclosed Fixed Rate Gives Students a Real 2026 Miami Multifamily Bank-Debt Benchmark",
         date="August 7, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/08/valley-national-bank-30m-refi-park-towers-miami/", "Valley National Bank refinanced Park Towers, a 210-unit, 10-story multifamily building")} at 777 NW 155th Lane in Miami with a $30 million loan at a disclosed fixed rate of 6.09%; borrower YMP Real Estate Management (Moshe Popack) has held the value-add asset since 2012, and Meridian Capital Group brokered the deal.''',
         why="Most CRE debt coverage doesn't disclose an actual interest rate, so a confirmed 6.09% fixed rate on a stabilized Miami multifamily refinancing is a genuinely useful, citable benchmark &mdash; students can use this specific number when discussing where regional bank multifamily debt is actually pricing in 2026, rather than relying on general market commentary about where rates &ldquo;probably&rdquo; sit.",
         implications=[
             "Provides a rare, specifically disclosed 6.09% fixed-rate benchmark for stabilized Miami multifamily bank debt",
             "Confirms regional banks (Valley National) remain active refinancing long-held, value-add Miami multifamily assets",
             "Adds a real comp for a 14-year ownership hold (since 2012) reaching a refinancing decision point",
             "Reinforces Meridian Capital Group's continued brokerage role in South Florida multifamily debt placement",
         ],
         watch="Whether comparable stabilized Miami multifamily refinancings price at similar fixed rates in the coming months."),
    dict(category="Bridge Lending", title="Madison Realty Capital and Yellowstone Provide $226.5M Bridge Refi for Hialeah's Metro Parc",
         subtitle="A Construction-to-Bridge Takeout Funds Lease-Up at a Newly Completed, Half-Leased Tower",
         date="July 29, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/07/madison-realty-miami-dade-baron-metro-parc-housing/", "Madison Realty Capital and Yellowstone Real Estate provided a $226.5 million bridge-to-permanent refinancing")} to Baron Property Group for Metro Parc, a newly completed, 10-story, 559-unit tower in Hialeah currently about 50% leased, refinancing the property out of its original construction debt while it stabilizes occupancy ahead of eventual permanent or agency financing.''',
         why="Taking a newly delivered tower out of construction debt and into bridge financing specifically during lease-up, rather than waiting for full stabilization, is the classic construction-to-bridge takeout playbook &mdash; two prominent debt funds underwriting a 50%-leased asset shows real confidence in the property's path to stabilization, a meaningfully different risk profile than either ground-up construction risk or a fully stabilized permanent loan.",
         implications=[
             "Provides a clean, large-scale example of the construction-to-bridge takeout structure during active lease-up",
             "Confirms two prominent debt funds underwrote a newly delivered, only-50%-leased Hialeah tower with real conviction",
             "Sets up a future permanent or agency refinancing once the property reaches full stabilization",
             "Adds a $226.5 million, 559-unit benchmark for comparable Miami-Dade lease-up bridge financings",
         ],
         watch="Metro Parc's leasing pace toward stabilization, and whether Baron Property Group refinances into permanent or agency debt once fully leased."),
    dict(category="Construction Lending", title="S3 Capital Lends $35M for Phase 3 of Attainable-Housing Project in Princeton, FL",
         subtitle="A Non-Bank Construction Lender Targets Florida's Attainable-Housing Gap",
         date="August 14, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/08/s3-capital-miami-dade-county-apartments/", "S3 Capital, a non-bank construction lender, financed the third phase of Casa Princeton")}, a mixed-income apartment community roughly 30 miles south of downtown Miami, with a $35 million construction loan to borrower Aconcagua Group for 162 units (part of a 374-unit total community) at 12835 SW 246th Terrace in Princeton, Florida; Berkadia arranged the financing.''',
         why="A non-bank construction lender specifically targeting Florida's &ldquo;attainable housing&rdquo; gap &mdash; middle-income product that's neither market-rate luxury nor deeply subsidized affordable housing &mdash; is a distinct lending niche from the trophy hospitality and condo deals dominating headline South Florida coverage, and a useful example of how alternative lenders find underserved segments of the multifamily construction market.",
         implications=[
             "Confirms non-bank construction lenders are actively targeting Florida's underserved attainable-housing segment",
             "Adds 162 units (of a 374-unit total community) to the Miami-Dade attainable-housing construction pipeline",
             "Provides a $35 million benchmark for comparable phased attainable-housing construction financings",
             "Reinforces Berkadia's continued role arranging South Florida multifamily construction debt",
         ],
         watch="Whether S3 Capital finances additional phases of Casa Princeton or comparable attainable-housing projects in Miami-Dade."),
    dict(category="Construction Lending", title="PNC Bank Provides $84.5M Construction Loan for Vybe 75 Near Tropical Park",
         subtitle="A Traditional Bank Lender Funds the First Phase of a Planned 1,000-Unit Community",
         date="August 11, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/08/coastland-miami-dade-vybe-75-housing-development/", "PNC Bank provided an $84.5 million construction loan to Coastland Residential")} for Vybe 75, a 366-unit first phase of a planned roughly 1,000-unit community at 4383 SW 75th Avenue near Tropical Park in Miami-Dade County, with a portion of units set aside for residents earning up to 120% of area median income.''''',
         why="A traditional bank lender, rather than a debt fund or non-bank alternative lender, funding ground-up multifamily construction at this scale shows conventional bank capital remains available for Miami-Dade multifamily development when the sponsor and site are strong enough &mdash; a useful counterpoint to the non-bank and alternative-lender deals dominating much of this desk's other South Florida construction coverage.",
         implications=[
             "Confirms traditional bank construction lending (PNC) remains available for large-scale Miami-Dade multifamily development",
             "Funds the first phase of a planned roughly 1,000-unit community near Tropical Park",
             "Sets aside a portion of units for residents up to 120% AMI, a moderate-income component within a market-rate project",
             "Provides an $84.5 million, 366-unit benchmark for comparable first-phase Miami-Dade multifamily construction loans",
         ],
         watch="Whether PNC or other traditional banks finance subsequent phases as Vybe 75 scales toward its full roughly 1,000-unit plan."),
    dict(category="Construction Lending", title="Deutsche Bank Lends $85M for Ground-Up Luxury Condo Tower on Miami Beach",
         subtitle="96% Presale Coverage De-Risks a Major International Bank's Construction Underwriting",
         date="July 27, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/07/deutsche-bank-miami-beach-condos/", "Deutsche Bank financed ground-up construction of a 222-unit, 12-story luxury condo tower")} at 7200 Collins Avenue in North Beach with an $85 million loan to borrower Northlink Capital, arranged by Arrow Real Estate Advisors; the project was already 96% under contract at closing.''',
         why="Ninety-six percent presale coverage before construction financing even closes is about as de-risked as ground-up condo construction lending gets, and it's exactly the kind of underwriting cushion that lets a major international bank like Deutsche Bank commit capital to condo construction &mdash; a property type many lenders remain cautious on given the binary nature of unit-by-unit closings.",
         implications=[
             "Shows a major international bank willing to fund condo construction specifically because presale coverage nearly eliminated sellout risk",
             "Provides a 96%-presold benchmark for how much coverage it takes to unlock major-bank condo construction financing",
             "Confirms continued luxury condo demand in Miami Beach's North Beach submarket specifically",
             "Adds Deutsche Bank to the roster of international banks actively lending on South Florida luxury residential construction",
         ],
         watch="Closing pace on the presold units as construction completes, and whether Deutsche Bank finances additional Miami condo towers with comparable presale coverage."),
    dict(category="Construction Lending", title="Witkoff and Monroe Capital Secure $302.6M Construction Loan for Miami Worldcenter Tower",
         subtitle="An Insurance Balance Sheet and a Bulge-Bracket Bank Club Together on One of the Summer's Largest Miami Loans",
         date="July 20, 2026",
         trigger=f'''{src("https://commercialobserver.com/2026/07/witkoff-monroe-capital-miami-worldcenter-apollo-jp-morgan/", "Witkoff and Monroe Capital secured a $302.6 million construction loan")} ($245.3 million in new money over $57.3 million of existing debt) from Apollo Global Management's Athene Annuity and Life Company alongside J.P. Morgan Chase, for the first phase (roughly 890 to 894 units) of a planned 2,100-plus-unit, three-tower master plan at 700 North Miami Avenue within the Miami Worldcenter mega-development on the former Miami Arena site near Brightline's MiamiCentral Station.''',
         why="Pairing an insurance-company balance sheet (Apollo's Athene) with a bulge-bracket bank (J.P. Morgan) in the same construction-loan club is a structure that blends long-duration, patient insurance capital with a bank's origination and syndication capability &mdash; a useful example of how the largest, most transit-connected mega-developments assemble capital stacks too large or too specialized for either lender type to underwrite alone.",
         implications=[
             "Sets one of the largest disclosed Miami construction loans of the summer at $302.6 million",
             "Shows an insurance-company balance sheet (Apollo/Athene) and a bulge-bracket bank (J.P. Morgan) co-lending in the same club",
             "Advances the first phase of a 2,100-plus-unit, three-tower master plan directly connected to Brightline's MiamiCentral Station",
             "Upsizes and refinances existing debt rather than funding entirely new capacity, extending the project's capital runway",
         ],
         watch="Construction progress on the first phase, and whether Witkoff and Monroe Capital secure comparable financing for the remaining two towers in the master plan."),
]

UF_DEBT_FINAL_PARAGRAPHS = [
    "Welcome to the first issue of RE Debt Signal's Miami coverage, launched for UF-area recruiting. This inaugural issue spans about seven weeks of real, dated activity, and it opens on Fortress's $263 million recapitalization of the St. Regis Bal Harbour Resort &mdash; a textbook &ldquo;performing but unrefinanceable&rdquo; maturity default that sat in special servicing for nearly a year despite the property remaining current and cash-flow positive.",
    "Construction lending dominates this launch issue, and it spans nearly every lender type at once: a non-bank lender targeting Florida's attainable-housing gap, a traditional bank (PNC) funding the first phase of a roughly 1,000-unit community, an international bank (Deutsche Bank) underwriting a 96%-presold condo tower, and an insurance-company/bulge-bracket-bank club financing one of the summer's largest Miami loans at Miami Worldcenter.",
    "Valley National Bank's disclosed 6.09% fixed-rate multifamily refinancing and Madison Realty/Yellowstone's $226.5 million construction-to-bridge takeout at Metro Parc round out the issue, giving South Florida CRE debt recruits both a rare citable rate benchmark and a clean example of lease-up bridge financing at scale.",
]
UF_DEBT_FINAL_BULLETS = [
    "Fortress recapitalized a trophy oceanfront resort that sat in special servicing for nearly a year despite staying current on debt service",
    "Construction lending spans nearly every lender type at once, from non-bank attainable-housing debt to an insurance/bulge-bracket bank club",
    "A rare disclosed 6.09% fixed rate gives students a real, citable 2026 Miami multifamily bank-debt benchmark",
    "A $302.6M construction loan for Miami Worldcenter's first tower is among the largest disclosed Miami loans of the summer",
]

REDEBT_UF_BLOCK = market_block_html(
    "redebt", "uf", False, "RE Debt", "Signal", "MIAMI, FL", "AUGUST 18, 2026", "JULY 20&ndash;AUG 18, 2026",
    UF_DEBT_SNAPSHOT, "What Happened", UF_DEBT_SIGNALS, UF_DEBT_FINAL_PARAGRAPHS, UF_DEBT_FINAL_BULLETS,
    "No predictions. No stock references. Loan-anchored interpretation only.",
)
...
STRUCTURED_SIGNALS = [
    ...
    dict(category="Esoteric ABS", title="Arby's Parent Brings Whole Business Securitization Ahead of IPO",
         subtitle="Franchise Royalty Cash Flows Get Securitized Right Before an Equity Event",
         date="August 11, 2026",
         trigger=f'''{src("https://www.globalcapital.com/securitization/article/2gqzo6ga9ig907ghmddkw/securitization/abs-us/sandwich-maker-arbys-brings-wbs-as-parents-ipo-looms", "Arby's parent company brought a whole business securitization ahead of its planned IPO")}, with reported sales up roughly $400 million and store count down since the company's 2020 WBS; full deal size and pricing were not disclosed.''',
         why="Timing a whole-business securitization &mdash; which monetizes franchise royalty and system-wide cash flows rather than a discrete asset pool &mdash; right before a planned IPO lets the sponsor lock in debt-market terms on the business's royalty stream before public equity investors get a vote on valuation. It's a clean, timely example of how franchise-model companies sequence securitization and equity events around each other.",
         implications=[
             "Times a whole-business securitization deliberately ahead of a planned IPO, sequencing debt and equity market access",
             "Reflects a changed underlying business (sales up ~$400 million, fewer stores) since the company's 2020 WBS",
             "Provides a timely, real-world case study in franchise royalty cash-flow securitization mechanics",
             "Adds another 2026 whole-business securitization to the shrinking list of retail/franchise issuers still using the structure",
         ],
         watch="The IPO's eventual pricing and timing relative to this WBS closing, and full deal terms once disclosed."),
    dict(category="Synthetic Risk Transfer", title="BNP Paribas Executes Its First Lombard Loan-Backed SRT",
         subtitle="Synthetic Risk Transfer Technology Extends Into Securities-Backed Lending",
         date="August 11, 2026",
         trigger=f'''{src("https://www.globalcapital.com/securitization/article/2gqz44ik6lho3icvyls74/securitization/abs-europe/bnp-executes-its-first-lombard-loan-backed-srt", "BNP Paribas completed a synthetic risk transfer referencing a Lombard loan book")} &mdash; loans secured by securities portfolios rather than real estate or corporate assets &mdash; under its &ldquo;Siena&rdquo; program, referencing a $1.5 billion portfolio.''',
         why="SRT technology extending into securities-backed (Lombard) lending, a collateral type it hasn't previously touched at this bank, shows the synthetic risk transfer toolkit continuing to expand beyond its traditional corporate, SME, and mortgage base &mdash; each new collateral type SRT reaches is a bank finding a new way to free up regulatory capital without selling the underlying loans outright.",
         implications=[
             "Extends synthetic risk transfer technology into a new collateral type (securities-backed Lombard lending) for BNP Paribas",
             "References a $1.5 billion portfolio, a meaningful first transaction in this specific collateral category",
             "Confirms SRT's continued expansion beyond its traditional corporate, SME, and mortgage collateral base",
             "Signals other banks with large Lombard lending books may explore similar capital-relief structures",
         ],
         watch="Whether BNP Paribas or other banks bring additional Lombard-loan SRT transactions, and how this collateral type performs relative to more established SRT categories."),
    dict(category="Consumer ABS", title="Soci&eacute;t&eacute; G&eacute;n&eacute;rale Restarts European Public ABS Market With Italian Auto Deal",
         subtitle="The First Public European ABS Print in Nearly a Month Marks a Clean Market-Reopening Signal",
         date="August 17, 2026",
         trigger=f'''{src("https://www.globalcapital.com/securitization/article/2grw7hnzqealtz5erffnk/securitization/abs-europe/societe-generale-restarts-market-with-italian-auto-abs", "Soci&eacute;t&eacute; G&eacute;n&eacute;rale priced an Italian auto ABS deal")}, the first public European ABS transaction since July 24, 2026; full deal size and pricing were not disclosed.''',
         why="A roughly three-and-a-half-week gap in public European ABS issuance, then a single bank stepping in to restart the market, is a clean, dated marker of a seasonal summer lull ending &mdash; useful for students learning to read primary-market issuance gaps as calendar effects rather than demand problems, since the market reopening on a single well-timed print (rather than staying shut) confirms underlying investor appetite never actually left.",
         implications=[
             "Marks the formal end of a roughly three-and-a-half-week European public ABS issuance gap",
             "Confirms a summer issuance lull was a calendar effect, not an underlying investor-demand problem",
             "Signals other European ABS issuers may follow now that the market has reopened",
             "Reinforces Soci&eacute;t&eacute; G&eacute;n&eacute;rale's active role as a repeat auto ABS issuer across European markets",
         ],
         watch="Whether other European ABS issuers follow with new deals in the weeks after this restart, confirming a genuine reopening rather than an isolated print."),
    dict(category="Consumer ABS", title="KBRA Assigns Preliminary Ratings to OCCU Auto Receivables Trust 2026-1",
         subtitle="A Credit Union's Captive Shelf Provides a Clean, Fully Documented Prime Auto ABS Comp",
         date="August 12, 2026",
         trigger=f'''{src("https://finance.yahoo.com/markets/options/articles/kbra-assigns-preliminary-ratings-occu-171500698.html", "KBRA assigned preliminary ratings to OCCU Auto Receivables Trust 2026-1")}, a $307.33 million deal across seven classes (A-1 through D) with credit enhancement ranging from 17.75% on the senior Class A down to 6.35% on Class D; the pool is backed by roughly 97% indirect (dealer-originated) prime auto loans from Oregon Community Credit Union, whose serviced portfolio stood at approximately $2.895 billion as of March 31, 2026.''',
         why="A credit union captive auto ABS shelf, fully documented with a complete seven-class enhancement ladder, is a clean, teachable prime-auto comp distinct from the fintech and near-prime auto deals this desk has covered recently &mdash; credit unions are a less-followed but real originator type in the auto ABS market, and this deal's full disclosure makes it a useful benchmark for comparing enhancement levels across issuer types.",
         implications=[
             "Provides a fully documented seven-class credit-enhancement ladder (17.75% to 6.35%) for prime auto ABS comparison",
             "Confirms credit unions remain active, real originators in the captive auto ABS market alongside banks and fintechs",
             "Adds a nearly $3 billion-serviced-portfolio credit union to the roster of programmatic auto ABS issuers",
             "Offers a prime-collateral counterpoint to the near-prime and nonprime auto ABS deals covered elsewhere this cycle",
         ],
         watch="Final ratings and pricing once the deal closes, and whether Oregon Community Credit Union returns with additional shelf issuance."),
    dict(category="CLO", title="Polus Prints Second New-Issue Euro CLO of the Year, AAAs Tighten 3bp",
         subtitle="A Concrete Three-Basis-Point Tightening Data Point Confirms Continued Euro CLO Spread Compression",
         date="August 11, 2026",
         trigger=f'''{src("https://www.globalcapital.com/securitization/article/2gqza7hr128yxdlk20ikg/securitization/clos-europe/polus-prints-its-second-new-issue-euro-clo-of-the-year", "Polus priced its second new-issue euro CLO of the year")}, with the triple-A notes pricing 3 basis points tighter than the manager's previous transaction.''',
         why="A specific, disclosed 3-basis-point tightening between two deals from the same manager in the same year is a concrete, comparable data point on continued euro CLO AAA spread compression &mdash; more useful than a general statement that spreads are tightening, since it isolates the change to one issuer's own cost of capital over a known time period.",
         implications=[
             "Provides a specific, comparable 3-basis-point AAA tightening data point from the same manager's own prior deal",
             "Confirms continued euro CLO spread compression is showing up in real, disclosed pricing, not just market commentary",
             "Adds Polus to the roster of managers pricing multiple new-issue euro CLOs within a single year",
             "Signals continued strong investor demand for euro CLO paper even amid broader new-issue volume concerns",
         ],
         watch="Whether Polus or comparable managers price a third 2026 euro CLO at even tighter levels, extending the compression trend."),
...
STRUCTURED_FINAL_PARAGRAPHS = [
    "This week's esoteric ABS signals show securitization reaching into new corners of the corporate capital structure. Arby's parent timing a whole-business securitization right ahead of its planned IPO, and BNP Paribas extending synthetic risk transfer technology into Lombard (securities-backed) lending for the first time, both confirm structured finance keeps finding new collateral types and new sequencing strategies around other capital markets events.",
    "Consumer and auto ABS cleared on both sides of the Atlantic this week. Soci&eacute;t&eacute; G&eacute;n&eacute;rale's Italian auto deal formally restarted the European public ABS market after a roughly three-and-a-half-week summer gap, while a fully documented, credit-union-originated prime auto deal from KBRA gives students a clean enhancement-ladder comp distinct from the fintech and near-prime deals covered recently.",
    "The CLO ratings-methodology story remains this issue's most consequential for how to actually read a rating, and Polus's concrete 3-basis-point AAA tightening between its own two 2026 deals is a real, comparable data point on how far euro CLO spread compression has actually gone this year.",
]
STRUCTURED_FINAL_BULLETS = [
    "A whole-business securitization landed deliberately ahead of Arby's parent's planned IPO, sequencing debt and equity market access",
    "Synthetic risk transfer technology reached a new collateral type (Lombard/securities-backed lending) for the first time at BNP Paribas",
    "The European public ABS market formally reopened after a roughly three-and-a-half-week summer gap",
...
STRUCTURED_PAGE = issue_page(
    "structured", False, "Structured", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "JULY 15&ndash;AUG 18, 2026",
...
SECURITIZED_SIGNALS = [
    ...
    dict(category="CMBS Conduit", title="KBRA Assigns Preliminary Ratings to BANK5 2026-5YR24, an $872.7M Diversified Conduit",
         subtitle="A Traditional Mixed-Property Pool Contrasts With Citi's Multifamily-Only Print",
         date="August 12, 2026",
         trigger=f'''{src("https://markets.financialcontent.com/wral/article/bizwire-2026-8-12-kbra-assigns-preliminary-ratings-to-bank5-2026-5yr24", "KBRA assigned preliminary ratings to BANK5 2026-5YR24, an $872.7 million multi-borrower CMBS conduit")} across 34 rated classes, backed by 35 commercial mortgage loans secured by 64 properties across 22 metro areas, led by retail (24.5%), industrial (14.0%), and mixed-use (12.9%) property types; the largest asset, Whalers Village, a Lahaina, Maui oceanfront shopping center, makes up 10.0% of the pool, and KBRA's cap-rate-adjusted valuations came in 38.3% below third-party appraisals on an aggregate basis.''',
         why="A broadly diversified conduit pool spanning retail, industrial, and mixed-use assets across 22 metro areas is a useful contrast to Citi's multifamily-only print from a few weeks earlier &mdash; the two deals together show both ends of the conduit spectrum are still finding investor demand, whether the pool is concentrated in one property type or spread across many. KBRA's own valuations running 38.3% below third-party appraisals is also a real, quantified data point on how conservatively the rating agency is underwriting this specific pool.",
         implications=[
             "Confirms traditional, broadly diversified conduit pools are still clearing the market alongside more concentrated single-property-type deals",
             "Provides a 22-metro-area, multi-property-type benchmark distinct from Citi's multifamily-only conduit",
             "Reveals a real, quantified 38.3% gap between KBRA's cap-rate-adjusted valuations and third-party appraisals",
             "Adds a large, real oceanfront retail asset (Whalers Village) as a name-brand anchor within a diversified pool",
         ],
         watch="Final ratings and pricing once the deal closes, and how the 38.3% valuation gap compares to KBRA's typical conduit adjustment levels."),
    ...
    dict(category="Non-Agency RMBS", title="KBRA Rates Onslow Bay's $342.7M Prime RMBS, a Distinct Shelf From PennyMac's",
         subtitle="A Second Prime, Agency-Eligible Issuer Shows the Category's Breadth Beyond a Single Sponsor",
         date="August 13, 2026",
         trigger=f'''{src("https://markets.financialcontent.com/wral/article/bizwire-2026-8-13-kbra-assigns-preliminary-ratings-to-obx-2026-ahc4-trust", "KBRA assigned preliminary ratings to OBX 2026-AHC4 Trust")}, a roughly $342.7 million prime RMBS deal backed by 626 residential mortgages across 64 rated classes, sponsored by Onslow Bay Financial (an Annaly-affiliated shelf) and originated and serviced entirely by AmeriHome Mortgage Company; it's the fourth 2026 issuance on Onslow Bay's OBX prime, agency-eligible shelf.''',
         why="A second distinct prime, agency-eligible RMBS issuer &mdash; Annaly's Onslow Bay shelf, separate from the PennyMac prime deal covered previously &mdash; confirms programmatic prime private-label issuance has real breadth across sponsors, not just a single active shelf. That both issuers are running fourth-plus-deal-of-2026 programs shows prime private-label securitization has become a routine, repeatable funding channel for multiple originators simultaneously.",
         implications=[
             "Confirms prime, agency-eligible RMBS issuance has real breadth across at least two distinct, active 2026 shelves",
             "Adds Annaly's Onslow Bay/AmeriHome program as a second programmatic prime issuer alongside PennyMac's shelf",
             "Signals prime private-label securitization has become routine and repeatable, not dependent on a single sponsor",
             "Provides a fourth-2026-deal cadence benchmark for comparable prime, agency-eligible shelf issuers",
         ],
         watch="Whether Onslow Bay maintains its 2026 issuance pace into Q4, and how OBX pricing compares to PennyMac's parallel prime shelf."),
    dict(category="Non-Agency RMBS", title="KBRA Rates $413.8M Non-Prime RMBS Blending QM and Business-Purpose Loans",
         subtitle="Nearly a Third Business-Purpose Collateral Shows Non-Prime Shelves Diversifying Further",
         date="August 11, 2026",
         trigger=f'''{src("https://markets.financialcontent.com/wral/article/bizwire-2026-8-11-kbra-assigns-preliminary-ratings-to-aspire-mortgage-trust-2026-5-spire-2026-5", "KBRA assigned preliminary ratings to Aspire Mortgage Trust 2026-5 (SPIRE 2026-5)")}, a $413.8 million non-prime RMBS deal backed by 742 residential mortgages across ten rated certificate classes; the pool is 99.6% fixed-rate, blending Safe Harbor QM (44.1%), Rebuttable Presumption QM (0.7%), Non-QM (23.9%), and ATR/QM-exempt business-purpose loans (31.2%).''',
         why="Nearly a third of this pool being business-purpose loans &mdash; made to investors rather than owner-occupants, and exempt from ability-to-repay rules entirely &mdash; shows non-prime RMBS shelves continuing to diversify their collateral mix well beyond the QM-exempt/non-QM blend this desk has tracked previously, adding an investor-loan category with its own distinct underwriting and performance drivers.",
         implications=[
             "Confirms non-prime RMBS shelves are diversifying further, now blending in a meaningful business-purpose loan component",
             "Adds investor/business-purpose loans (31.2% of the pool) as a distinct collateral type with its own underwriting drivers",
             "Provides a second 2026 Aspire Mortgage Trust data point, following the earlier Lone Star-adjacent non-prime coverage",
             "Signals continued underwriting-box expansion as issuers seek enough loan volume to sustain programmatic issuance",
         ],
         watch="How the business-purpose loan tranche of this pool performs relative to its owner-occupant QM and non-QM collateral over time."),
    dict(category="Non-Agency RMBS", title="Goldman Sachs Prices $308.9M HELOC Securitization, Its Second of 2026",
         subtitle="A Revolving, Draw-Based Structure Is a Distinct Product From Closed-End Second Liens",
         date="August 17, 2026",
         trigger=f'''{src("https://markets.financialcontent.com/wral/article/bizwire-2026-8-17-kbra-assigns-preliminary-ratings-to-gs-mortgage-backed-securities-trust-2026-he2-gsmbs-2026-he2", "KBRA assigned preliminary ratings to GS Mortgage-Backed Securities Trust 2026-HE2")}, a $308.9 million securitization across six rated classes backed by 3,088 loans, predominantly second-lien (89.1%, versus 10.9% first-lien), interest-only adjustable-rate home equity lines of credit; United Wholesale Mortgage originated 44.3% of the pool, which carried a 93.7% draw utilization rate as of the July 31 cutoff.''',
         why="A HELOC &mdash; a revolving, draw-based credit line &mdash; is structurally distinct from the closed-end second-lien deals this desk has covered previously, since the collateral balance can fluctuate as borrowers draw and repay rather than amortizing on a fixed schedule. A 93.7% draw utilization rate is a real, quantified data point on how fully borrowers are actually using their available credit, which matters directly for how these bonds' cash flows behave relative to a fixed-balance second-lien pool.",
         implications=[
             "Distinguishes revolving, draw-based HELOC securitization structurally from closed-end second-lien deals covered previously",
             "Provides a real 93.7% draw-utilization data point, a key performance driver unique to revolving credit-line collateral",
             "Confirms Goldman Sachs' continued programmatic HELOC issuance with a second 2026 deal from the same shelf",
             "Adds United Wholesale Mortgage's origination share (44.3%) as a name-brand contributor to non-agency RMBS home-equity supply",
         ],
         watch="Whether draw utilization holds near 93.7% as the pool seasons, and if Goldman Sachs prices a third 2026 HELOC deal."),
    ...
    dict(category="Rating Action", title="CMBS Conduit Loan Payoff Rate Hits a Four-Year High of 72.05%",
         ...
         why="A four-year-high payoff rate, tracked at the same time as this week's rising 30-day delinquency figure, shows CMBS performance data genuinely pulling in different directions depending on which slice you look at &mdash; refinancing conditions are clearly improving enough to let more conduit loans pay off in full at maturity, even as other parts of the market show real, concurrent stress.",
         implications=[
             "Confirms refinancing conditions have improved enough to lift the conduit payoff rate to a four-year high",
             "Provides a genuine positive counterpoint to this week's delinquency and late-payment stress data",
...
SECURITIZED_FINAL_PARAGRAPHS = [
    "This week's CMBS conduit issuance shows both ends of the pool-construction spectrum clearing the market. Citi's multifamily-only conduit, still fresh from prior weeks, is joined by BANK5 2026-5YR24, an $872.7 million pool spread across 22 metro areas and multiple property types &mdash; a useful contrast confirming both concentrated and broadly diversified conduit structures are finding real investor demand right now.",
    "Non-agency RMBS issuance keeps broadening across sponsors and structures. A second distinct prime shelf (Annaly's Onslow Bay), a non-prime deal blending in nearly a third business-purpose collateral, and a revolving HELOC securitization with a real 93.7% draw-utilization data point together show private-label RMBS supply diversifying across issuer, collateral type, and structure simultaneously.",
    "This week's CMBS performance data continues to pull in different directions depending on the metric: a leading 30-day late-payment figure spiked to 8.01% in July, while the conduit loan payoff rate simultaneously hit a four-year high of 72.05% &mdash; confirming refinancing conditions are real even as other slices of the market show concurrent stress.",
]
SECURITIZED_FINAL_BULLETS = [
    "An $872.7M diversified conduit pool across 22 metro areas contrasts with Citi's multifamily-only print from prior weeks",
    "A second distinct prime RMBS shelf and a HELOC deal with 93.7% draw utilization show non-agency RMBS structures broadening",
    "Nearly a third of a new non-prime RMBS pool is business-purpose investor collateral, a further underwriting-box expansion",
    "The CMBS conduit payoff rate hit a four-year high of 72.05% even as a leading late-payment indicator spiked to 8.01%",
]

SECURITIZED_PAGE = issue_page(
    "securitized", False, "Securitized", "Signal", "NEW YORK, NY", "AUGUST 18, 2026", "JULY 15&ndash;AUG 18, 2026",
...
# ============================================================== FROZEN SNAPSHOTS (week of Aug 10, 2026) ==============================================================
...
AUSTIN_DEBT_FINAL_PARAGRAPHS_0810 = [
...
AUSTIN_DEBT_FINAL_BULLETS_0810 = [
...
USC_DEBT_FINAL_PARAGRAPHS_0810 = [
...
NYC_DEBT_FINAL_PARAGRAPHS_0810 = [
...
STRUCTURED_FINAL_PARAGRAPHS_0810 = [
...
SECURITIZED_FINAL_PARAGRAPHS_0810 = [
...
SECURITIZED_FINAL_BULLETS_0810 = [
...
ARCHIVE_ENTRIES = [
    ...
    ("cre-austin-20260810", "CRE &middot; Austin, TX &middot; Aug 10, 2026", "CRE", "Signal", "AUSTIN, TEXAS", "AUGUST 10, 2026", "JULY 23&ndash;AUG 10, 2026", CRE_SNAPSHOT_0810, CRE_SIGNALS_0810, CRE_FINAL_PARAGRAPHS_0810, CRE_FINAL_BULLETS_0810, "No predictions. No stock references. Project-anchored interpretation only.", "Local Market Implications"),
    ("cre-usc-20260810", "CRE &middot; Los Angeles, CA &middot; Aug 10, 2026", "CRE", "Signal", "LOS ANGELES, CA", "AUGUST 10, 2026", "JULY 15&ndash;AUG 10, 2026", USC_SNAPSHOT_0810, USC_SIGNALS_0810, USC_FINAL_PARAGRAPHS_0810, USC_FINAL_BULLETS_0810, "No predictions. No stock references. Project-anchored interpretation only.", "Local Market Implications"),
    ("cre-nyu-20260810", "CRE &middot; New York, NY &middot; Aug 10, 2026", "CRE", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "JULY 28&ndash;AUG 10, 2026", NYC_SNAPSHOT_0810, NYC_SIGNALS_0810, NYC_FINAL_PARAGRAPHS_0810, NYC_FINAL_BULLETS_0810, "No predictions. No stock references. Project-anchored interpretation only.", "Local Market Implications"),
    ("redebt-austin-20260810", "RE Debt &middot; Austin, TX &middot; Aug 10, 2026", "RE Debt", "Signal", "AUSTIN, TEXAS", "AUGUST 10, 2026", "JUNE 2&ndash;AUG 10, 2026", AUSTIN_DEBT_SNAPSHOT_0810, AUSTIN_DEBT_SIGNALS_0810, AUSTIN_DEBT_FINAL_PARAGRAPHS_0810, AUSTIN_DEBT_FINAL_BULLETS_0810, "No predictions. No stock references. Loan-anchored interpretation only.", "Market Implications"),
    ("redebt-usc-20260810", "RE Debt &middot; Los Angeles, CA &middot; Aug 10, 2026", "RE Debt", "Signal", "LOS ANGELES, CA", "AUGUST 10, 2026", "JULY 15&ndash;AUG 10, 2026", USC_DEBT_SNAPSHOT_0810, USC_DEBT_SIGNALS_0810, USC_DEBT_FINAL_PARAGRAPHS_0810, USC_DEBT_FINAL_BULLETS_0810, "No predictions. No stock references. Loan-anchored interpretation only.", "Market Implications"),
    ("redebt-nyu-20260810", "RE Debt &middot; New York, NY &middot; Aug 10, 2026", "RE Debt", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "JULY 28&ndash;AUG 10, 2026", NYC_DEBT_SNAPSHOT_0810, NYC_DEBT_SIGNALS_0810, NYC_DEBT_FINAL_PARAGRAPHS_0810, NYC_DEBT_FINAL_BULLETS_0810, "No predictions. No stock references. Loan-anchored interpretation only.", "Market Implications"),
    ("repe-20260810", "REPE Signal &middot; Aug 10, 2026", "REPE", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "JUNE 29&ndash;AUG 10, 2026", REPE_SNAPSHOT_0810, REPE_SIGNALS_0810, REPE_FINAL_PARAGRAPHS_0810, REPE_FINAL_BULLETS_0810, "No predictions. No stock references. Platform-anchored interpretation only.", "Market Implications"),
    ("ib-20260810", "IB Signal &middot; Aug 10, 2026", "IB", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "AUGUST 3&ndash;10, 2026", IB_SNAPSHOT_0810, IB_SIGNALS_0810, IB_FINAL_PARAGRAPHS_0810, IB_FINAL_BULLETS_0810, "No predictions. No stock references. Deal-anchored interpretation only.", "Market Implications"),
    ("credit-20260810", "Credit Signal &middot; Aug 10, 2026", "Credit", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "JULY 28&ndash;AUG 10, 2026", CREDIT_SNAPSHOT_0810, CREDIT_SIGNALS_0810, CREDIT_FINAL_PARAGRAPHS_0810, CREDIT_FINAL_BULLETS_0810, "No predictions. No stock references. Facility-anchored interpretation only.", "Market Implications"),
    ("structured-20260810", "Structured Signal &middot; Aug 10, 2026", "Structured", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "JULY 20&ndash;AUG 10, 2026", STRUCTURED_SNAPSHOT_0810, STRUCTURED_SIGNALS_0810, STRUCTURED_FINAL_PARAGRAPHS_0810, STRUCTURED_FINAL_BULLETS_0810, "No predictions. No stock references. Structure-anchored interpretation only.", "Market Implications"),
    ("securitized-20260810", "Securitized Signal &middot; Aug 10, 2026", "Securitized", "Signal", "NEW YORK, NY", "AUGUST 10, 2026", "JULY 15&ndash;AUG 10, 2026", SECURITIZED_SNAPSHOT_0810, SECURITIZED_SIGNALS_0810, SECURITIZED_FINAL_PARAGRAPHS_0810, SECURITIZED_FINAL_BULLETS_0810, "No predictions. No stock references. Pool-anchored interpretation only.", "Market Implications"),
]
